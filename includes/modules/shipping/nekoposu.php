...
*/
	...
	//　Japanese
		...
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('最大内部長さ', 'MODULE_SHIPPING_NEKOPOSU_MAX_LENGTH', '28', '封筒内容積の最大長。', '6', '0', now())");
		...
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('最大内高', 'MODULE_SHIPPING_NEKOPOSU_MAX_HEIGHT', '2.5', '封筒内容積の最大高さ。', '6', '0', now())");
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('最大内周', 'MODULE_SHIPPING_NEKOPOSU_MAX_GIRTH', '48', '封筒内容積の最大周囲。', '6', '0', now())");
