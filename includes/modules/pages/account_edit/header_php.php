...
if ($_SESSION['language'] == 'japanese') {
  ...
  if ($error == false) {
    ...
    $sql_data_array = array(array('fieldName'=>'customers_firstname', 'value'=>$firstname, 'type'=>'stringIgnoreNull'),
                            array('fieldName'=>'customers_firstname_kana', 'value'=>$firstname_kana, 'type'=>'stringIgnoreNull'),
                            array('fieldName'=>'customers_lastname', 'value'=>$lastname, 'type'=>'stringIgnoreNull'),
                            array('fieldName'=>'customers_lastname_kana', 'value'=>$lastname_kana, 'type'=>'stringIgnoreNull'),
