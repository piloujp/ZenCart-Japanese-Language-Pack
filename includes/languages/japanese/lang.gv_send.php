...
$define = [
    ...
    'MAIN_MESSAGE' => '%1$s 相当の「. TEXT_GV_NAME.」を、メール アドレスが %3$s である %2$s様に送信しています。詳細が正しくない場合は、[<strong>編集</strong>] ボタンをクリックしてメッセージを編集できます。<br><br>送信するメッセージは次のとおりです:<br><br>',
    'SECONDARY_MESSAGE' => '%1$s様<br><br>' . '%2$sの' . TEXT_GV_NAME . 'が%3$s様から贈られました。',
