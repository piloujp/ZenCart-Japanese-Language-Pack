...
$define = [
    ...
    'NAVBAR_TITLE_2' => '手続完了',
    'HEADING_TITLE' => 'ご注文の手続きが完了しました。',
    'TEXT_SUCCESS' => '',
    'TEXT_NOTIFY_PRODUCTS' => '下記商品についてお知らせメールを希望する',
    'TEXT_SEE_ORDERS' => '<a href="' . zen_href_link(FILENAME_ACCOUNT) . '">マイページ</a>からお客様のご注文履歴をご覧いただけます。',
