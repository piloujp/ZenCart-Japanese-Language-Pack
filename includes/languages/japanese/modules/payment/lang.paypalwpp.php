...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALWPP_TEXT_REFUND_INITIATED' => 'PayPalに対して %s の返金処理を実行しました。 取引ID: %s。ブラウザ画面の再読み込みを行い注文ステータスとステータス更新履歴のコメントが更新されている事を確認してください。',
    'MODULE_PAYMENT_PAYPALWPP_TEXT_AUTH_INITIATED' => 'PayPalに対して %s への承認処理を実行しました。ブラウザ画面の再読み込みを行い注文ステータスとステータス更新履歴のコメントが更新されている事を確認してください。',
    'MODULE_PAYMENT_PAYPALWPP_TEXT_CAPT_INITIATED' => 'PayPalに対して %s への回収処理を実行しました。受取ID: %s。ブラウザ画面の再読み込みを行い注文ステータスとステータス更新履歴のコメントが更新されている事を確認してください。',
