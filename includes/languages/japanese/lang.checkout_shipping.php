<?php
$define = [
    'NAVBAR_TITLE_1' => 'レジへ進む',
    'NAVBAR_TITLE_2' => '配送情報',
    'HEADING_TITLE' => 'ステップ１/３ - お届け先情報',
    'TEXT_CHOOSE_SHIPPING_DESTINATION' => 'ご注文の品物は表示されている住所にお届けします。『住所を変更』ボタンをクリックしてお届け先を変更できます。',
    'TITLE_SHIPPING_ADDRESS' => 'お届け先:',
    'TEXT_CHOOSE_SHIPPING_METHOD' => 'ご希望の配送方法をお選び下さい。',
    ...
    'ERROR_PLEASE_RESELECT_SHIPPING_METHOD' => 'ご利用いただける配送方法が変更されました。配送方法を再選択して下さい。',
];
