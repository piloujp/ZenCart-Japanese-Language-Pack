...
$define = [
    ...
    'TEXT_COUPON_HELP_DATE' => 'このクーポンは%s ～ %s の間に限り有効です。',
    ...
    'TEXT_DISPLAY_NUMBER_OF_ORDERS' => '<strong>%d</strong>から<strong>%d</strong> を表示中 (ご注文数: <strong>%d</strong>)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS' => '<strong>%d</strong>から<strong>%d</strong> を表示中 (商品の数: <strong>%d</strong>)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_ALL' => '<strong>%d</strong>から<strong>%d</strong>を表示中 (全商品の数:<strong>%d</strong>)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_FEATURED_PRODUCTS' => '<strong>%d</strong>から<strong>%d</strong>を表示中 (おすすめ商品の数:<strong>%d</strong>)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW' => '<strong>%d</strong>から<strong>%d</strong> を表示中 (新着商品の数: <strong>%d</strong>)',
    'TEXT_DISPLAY_NUMBER_OF_REVIEWS' => '<strong>%d</strong>から<strong>%d</strong> を表示中 (レビュー数: <strong>%d</strong>)',
    'TEXT_DISPLAY_NUMBER_OF_SPECIALS' => '<strong>%d</strong>から<strong>%d</strong> を表示中 (特価商品の数: <strong>%d</strong>)',
    ...
    'TEXT_INVALID_COUPON_PRODUCT' => '現在カートに入っている商品でこのクーポンコードをお使いいただけるものがありません。',
    'TEXT_INVALID_FINISHDATE_COUPON' => 'このクーポンは有効期限切れです。',
    'TEXT_INVALID_REDEEM_COUPON' => '無効なクーポンコードです',
    'TEXT_INVALID_REDEEM_COUPON_MINIMUM' => 'このクーポンは %s 円以上のお買い物でご利用いただけます',
    ...
    'TEXT_INVALID_USES_COUPON' => 'このクーポンは全てのお客様のご利用回数の合計で最大 ',
    'TEXT_INVALID_USES_USER_COUPON' => 'クーポンコード: %s は既に最大使用回数に達しています。このクーポンはお客様ごとに最大 ',
