...
?>
  ...
  <h4 id="checkoutConfirmDefaultShipmentTitle"><?php echo $order->info['shipping_method'] . (!empty($order->delivery['timespec']) ? '<br>' . TEXT_TIME_SPECIFY . $order->delivery['timespec'] :''); ?></h4>
