...
class order extends base
{
    ...
    function query($order_id)
    {
        ...
        $this->delivery = [
            ...
            'timespec' => $order->fields['delivery_timespec'],
        ];
...
//            'cc_cvv' => (isset($GLOBALS['cc_cvv']) ? $GLOBALS['cc_cvv'] : ''),
    ...
    function create($zf_ot_modules)
    {
        ...
        $sql_data_array = [
            ...
            'customers_name' => ($this->customer['country']['id'] == zen_jp_country_id()) ? $this->customer['lastname'] . ' ' . $this->customer['firstname'] : $this->customer['firstname'] . ' ' . $this->customer['lastname'],
            ...
            'customers_state' => $_SESSION['language'] === 'japanese' ? $this->customer['state_code'] : $this->customer['state'],
            ...
            'delivery_name' => ($this->delivery['country']['id'] == zen_jp_country_id()) ? $this->delivery['lastname'] . ' ' . $this->delivery['firstname'] : $this->delivery['firstname'] . ' ' . $this->delivery['lastname'],
            ...
            'delivery_state' => $_SESSION['language'] === 'japanese' ? $this->delivery['state_code'] : $this->delivery['state'],
            'delivery_country' => $this->delivery['country']['title'],
            'delivery_address_format_id' => (int)$this->delivery['format_id'],
            'billing_name' => ($this->billing['country']['id'] == zen_jp_country_id()) ? $this->billing['lastname'] . ' ' . $this->billing['firstname'] : $this->billing['firstname'] . ' ' . $this->billing['lastname'],
            ...
            'billing_state' => $_SESSION['language'] === 'japanese' ? $this->billing['state_code'] : $this->billing['state'],
    ...
    function send_order_email($zf_insert_id = null)
    {
        ...
        $html_msg = [];
		$customerGreet = $this->customer['country']['id'] == zen_jp_country_id() ? $this->customer['lastname'] . ' ' . $this->customer['firstname'] . EMAIL_GREET : $this->customer['firstname'] . ' ' . $this->customer['lastname'];
        ...
        $html_msg['TEXT_TIME_SPECIFY'] = (!empty($this->delivery['timespec'])) ? TEXT_TIME_SPECIFY : '';
    ...
    $GLOBALS[$payment_class]->email_footer != '') ? nl2br($GLOBALS[$payment_class]->email_footer) : (isset($this->info['cc_type']) && $this->info['cc_type'] != '' ? $this->info['cc_type'] . ' ' . $cc_num_display : '');
        ...
        $html_msg['EMAIL_FIRST_NAME'] = ($this->customer['country']['id'] == zen_jp_country_id()) ? $this->customer['lastname'] . ' ' . $this->customer['firstname'] : $this->customer['firstname'];
        $html_msg['EMAIL_LAST_NAME'] = ($this->customer['country']['id'] == zen_jp_country_id()) ? '' : $this->customer['lastname'];
		$html_msg['EMAIL_GREET'] = EMAIL_GREET;
        //  $html_msg['EMAIL_TEXT_HEADER'] = EMAIL_TEXT_HEADER;
