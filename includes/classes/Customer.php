 ...
 * @version $Id: piloujp 2024 Feb 20 Modified in v2.0.0-beta1 $
 */
    ...
    public function getFormattedAddressBookList(int $customer_id = null): array
    {
        ...
        foreach ($results as $result) {
            ...
            $addressArray[] = [
                ...
                'firstname_kana' => $result['firstname_kana'],
                'lastname_kana' => $result['lastname_kana'],
            ...
            $db->Execute(
                "UPDATE " . TABLE_CUSTOMERS . "
                    SET customers_gender = '',
                        ...
                        customers_firstname_kana = '" . $text_deleted . "',
                        customers_lastname_kana = '" . $text_deleted . "',
