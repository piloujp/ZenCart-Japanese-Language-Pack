...
UPDATE project_version SET project_version_minor = '0.0-alpha1', project_version_comment = 'New Installation-v200-alpha1 with Japanese Pack v2.0.0', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Main';
