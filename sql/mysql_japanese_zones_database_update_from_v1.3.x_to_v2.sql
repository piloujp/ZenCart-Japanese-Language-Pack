...
UPDATE project_version SET project_version_minor = '2.0210', project_version_comment = 'Manual version update with Japanese Pack v2.2.2', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Database';
