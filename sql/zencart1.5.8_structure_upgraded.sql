...
CREATE TABLE `zen_count_product_views` (
...
CREATE TABLE `zen_customers_to_groups` (
  `id` int UNSIGNED NOT NULL,
...
CREATE TABLE `zen_customer_groups` (
  `group_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `zen_orders` (
  ...
  `delivery_timespec` varchar(32) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `zen_plugin_control` (
...
CREATE TABLE `zen_plugin_control_versions` (
  `unique_key` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `zen_plugin_groups` (
  `unique_key` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `zen_plugin_groups_description` (
...
CREATE TABLE `zen_square_payments` (
  `id` int UNSIGNED NOT NULL,
...
ALTER TABLE `zen_address_format`
  ADD PRIMARY KEY (`address_format_id`);

ALTER TABLE `zen_admin`
...
ALTER TABLE `zen_admin_activity_log`
...
ALTER TABLE `zen_count_product_views`
...
ALTER TABLE `zen_files_uploaded`
  ADD PRIMARY KEY (`files_uploaded_id`),
  ADD KEY `idx_customers_id_zen` (`customers_id`);

ALTER TABLE `zen_geo_zones`
  ADD PRIMARY KEY (`geo_zone_id`);

ALTER TABLE `zen_get_terms_to_filter`
  ADD PRIMARY KEY (`get_term_name`);

ALTER TABLE `zen_group_pricing`
  ADD PRIMARY KEY (`group_id`);

ALTER TABLE `zen_languages`
  ADD PRIMARY KEY (`languages_id`),
  ADD KEY `idx_languages_name_zen` (`name`);

ALTER TABLE `zen_layout_boxes`
...
ALTER TABLE `zen_orders_products`
...
ALTER TABLE `zen_paypal`
  ADD PRIMARY KEY (`paypal_ipn_id`,`txn_id`),
  ADD KEY `idx_order_id_zen` (`order_id`);

ALTER TABLE `zen_paypal_payment_status`
  ADD PRIMARY KEY (`payment_status_id`);

ALTER TABLE `zen_paypal_payment_status_history`
  ADD PRIMARY KEY (`payment_status_history_id`),
  ADD KEY `idx_paypal_ipn_id_zen` (`paypal_ipn_id`);

ALTER TABLE `zen_paypal_session`
  ADD PRIMARY KEY (`unique_id`),
  ADD KEY `idx_session_id_zen` (`session_id`(36));

ALTER TABLE `zen_paypal_testing`
  ADD PRIMARY KEY (`paypal_ipn_id`,`txn_id`),
  ADD KEY `idx_order_id_zen` (`order_id`);

ALTER TABLE `zen_plugin_control`
  ADD PRIMARY KEY (`unique_key`);

ALTER TABLE `zen_plugin_control_versions`
  ADD PRIMARY KEY (`unique_key`,`version`);

ALTER TABLE `zen_plugin_groups`
  ADD PRIMARY KEY (`unique_key`);

ALTER TABLE `zen_plugin_groups_description`
...
ALTER TABLE `zen_products_attributes`
...
ALTER TABLE `zen_products_attributes_download`
  ADD PRIMARY KEY (`products_attributes_id`);

ALTER TABLE `zen_products_description`
  ADD PRIMARY KEY (`products_id`,`language_id`),
  ADD KEY `idx_products_name_zen` (`products_name`);

ALTER TABLE `zen_products_discount_quantity`
  ADD KEY `idx_id_qty_zen` (`products_id`,`discount_qty`);

ALTER TABLE `zen_products_notifications`
  ADD PRIMARY KEY (`products_id`,`customers_id`);

ALTER TABLE `zen_products_options`
...
ALTER TABLE `zen_products_options_types`
  ADD PRIMARY KEY (`products_options_types_id`);

ALTER TABLE `zen_products_options_values`
...
ALTER TABLE `zen_products_options_values_to_products_options`
...
ALTER TABLE `zen_reviews_description`
  ADD PRIMARY KEY (`reviews_id`,`languages_id`);

ALTER TABLE `zen_salemaker_sales`
...
ALTER TABLE `zen_sessions`
  ADD PRIMARY KEY (`sesskey`);

ALTER TABLE `zen_specials`
