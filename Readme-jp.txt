...
----
----
管理インターフェイスにログインし、言語に移動し、必要に応じて日本語をデフォルトとして設定します。
次に、[ツール] --> [レイアウト ボックス コントローラー] に移動し、言語ボックスをオンに設定します。
次に、通貨として日本円を追加し、日本の税金を設定して、新しいジオゾーンを作成する必要があります。 ファイル「mysql_japanese_config.sql」はこれに役立ちますが、カスタマイズする必要がある場合があります。
