...
UPDATE project_version SET project_version_minor = '0.0-beta1', project_version_comment = 'New Installation-v200-beta1 with Japanese Pack v2.0.0', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Main';
UPDATE project_version SET project_version_minor = '0.0200', project_version_comment = 'New Installation-v200-beta1 with Japanese Pack v2.0.0', project_version_date_applied = now() WHERE project_version_key = 'Zen-Cart Database';
