...
UPDATE configuration SET configuration_title = 'リンク切れページのチェック',  configuration_description = 'Zen Cartがリンク切れページを検知した際に自動的にトップページに転送しますか?<br>・On = オン<br>・Off = オフ<br>・Page Not Found = ページが見つかりません画面へ遷移する<br>注意：デバックの際などにはこの機能をオフにするとよいでしょう。' WHERE `configuration_key` = 'MISSING_PAGE_CHECK';
...
UPDATE configuration SET configuration_title = 'メーカーリスト - 商品の存在を確認',  configuration_description = '各メーカーについて、1点以上の商品があり、かつ閲覧可能であるかどうかを確認しますか?<br>注意：この機能がONの場合、商品数やメーカーの数が多いと表示が遅くなります。<br>0= off 1= on' WHERE `configuration_key` = 'PRODUCTS_MANUFACTURERS_STATUS';
...
UPDATE configuration SET configuration_title = 'ショッピングカートの中身 - 商品画像の表示オン・オフ',  configuration_description = 'ショッピングカートの中身に入っている商品の画像を表示するかどうかを設定します。<br>・0= off<br>・1= on' WHERE `configuration_key` = 'IMAGE_SHOPPING_CART_STATUS';
...
UPDATE configuration SET configuration_title = '商品画像 - 画像がない場合のNo Image画像',  configuration_description = '「No Image」画像を自動的に表示するかどうかを設定します。<br>・0= off<br>・1= On<br>' WHERE `configuration_key` = 'PRODUCTS_IMAGE_NO_IMAGE_STATUS';
...
UPDATE configuration SET configuration_title = '商品画像 - 商品・カテゴリでプロポーショナルな画像を使う',  configuration_description = '商品情報・カテゴリでプロポーショナルな画像を使いますか?<br>注意：プロポーショナル画像には高さ・横幅とも"0"(ピクセル)を指定しないでください。<br>0= off 1= on' WHERE `configuration_key` = 'PROPORTIONAL_IMAGES_STATUS';
...
UPDATE configuration SET configuration_title = '小・中パッケージの風袋 - 比率・重量',  configuration_description = '典型的な小・中パッケージの風袋(ふうたい：大きさと重量)を設定します。<br>例：10% + 1kg 10:1<br>10% + 0kg 10:0<br>0% + 5kg 0:5<br>0% + 0kg 0:0' WHERE `configuration_key` = 'SHIPPING_BOX_WEIGHT';
UPDATE configuration SET configuration_title = '大型パッケージの風袋 - 大きさ・重量',  configuration_description = '大きなパッケージの風袋風袋(ふうたい：大きさと重量)を設定します。<br>例：10% + 1kg 10:1<br>10% + 0kg 10:0<br>0% + 5kg 0:5<br>0% + 0kg 0:0' WHERE `configuration_key` = 'SHIPPING_BOX_PADDING';
UPDATE configuration SET configuration_title = '個数と重量の表示',  configuration_description = '配送する荷物の個数と重量を表示するかどうかを設定します。<br>・0= off<br>・1= 個数のみ表示<br>・2= 重量のみ表示<br>・3= 両方表示' WHERE `configuration_key` = 'SHIPPING_BOX_WEIGHT_DISPLAY';
UPDATE configuration SET configuration_title = '送料概算表示の表示・非表示',  configuration_description = '送料概算ボタンの表示するかどうかを設定します。<br>・0= Off<br>・1= ショッピングカート上にボタンとして表示<br>・2= ショッピングカートページにリストとして表示' WHERE `configuration_key` = 'SHOW_SHIPPING_ESTIMATOR_BUTTON';
...
UPDATE configuration SET configuration_title = 'リスト内各商品への注文数量欄の表示とボタンの表示',  configuration_description = 'リスト内各商品への数量欄の表示の有無と「選択した商品をカートに追加」ボタンの表示位置を設定します。<br>0= off<br>1= 上部<br>2= 下部<br>3= 両方' WHERE `configuration_key` = 'PRODUCT_LISTING_MULTIPLE_ADD_TO_CART';
...
UPDATE configuration SET configuration_title = '商品数量に指定できる小数点の桁数',  configuration_description = '商品の数量に小数点の利用を許可する桁数を設定します。<br>・0= off' WHERE `configuration_key` = 'QUANTITY_DECIMALS';
...
UPDATE configuration SET configuration_title = 'ショッピングカートが空の場合の新着商品の表示',  configuration_description = 'ショッピングカートが空の場合の新着商品の表示を設定します。<br>・0= off' WHERE `configuration_key` = 'SHOW_SHOPPING_CART_EMPTY_NEW_PRODUCTS';
UPDATE configuration SET configuration_title = 'ショッピングカートが空の場合のおすすめ商品の表示',  configuration_description = 'ショッピングカートが空の場合のおすすめ商品の表示を設定します。。<br>・0= off' WHERE `configuration_key` = 'SHOW_SHOPPING_CART_EMPTY_FEATURED_PRODUCTS';
UPDATE configuration SET configuration_title = 'ショッピングカートが空の場合の特価商品の表示',  configuration_description = 'ショッピングカートが空の場合の特価商品の表示を設定します。<br>・0= off' WHERE `configuration_key` = 'SHOW_SHOPPING_CART_EMPTY_SPECIALS_PRODUCTS';
UPDATE configuration SET configuration_title = 'ショッピングカートが空の場合の入荷予定商品の表示',  configuration_description = 'ショッピングカートが空の場合の入荷予定商品の表示を設定します。<br>・0= off' WHERE `configuration_key` = 'SHOW_SHOPPING_CART_EMPTY_UPCOMING';
...
UPDATE configuration SET configuration_title = 'アカウント作成完了メール(コピー)の送信',  configuration_description = 'アカウント作成完了メールのコピーを指定のメールアドレスに送信しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'SEND_EXTRA_CREATE_ACCOUNT_EMAILS_TO_STATUS';
...
UPDATE configuration SET configuration_title = 'ギフト券送付メール(コピー)の送信',  configuration_description = '顧客が送付するギフト券送付メールのコピーを送信しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'SEND_EXTRA_GV_CUSTOMER_EMAILS_TO_STATUS';
...
UPDATE configuration SET configuration_title = 'ショップ運営者からのギフト券送付メール(コピー)の送信',  configuration_description = 'ショップ運営者からのギフト券送付メールのコピーを送信しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'SEND_EXTRA_GV_ADMIN_EMAILS_TO_STATUS';
...
UPDATE configuration SET configuration_title = 'ショップ運営者の注文ステータスメール(コピー)の送信',  configuration_description = 'ショップ運営者の注文ステータスメールのコピーを送信しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'SEND_EXTRA_ORDERS_STATUS_ADMIN_EMAILS_TO_STATUS';
...
UPDATE configuration SET configuration_title = '「お問い合わせ」にショップ名と住所を表記',  configuration_description = '「お問い合わせ」画面にショップ名と住所を表記するかどうかを設定します。<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CONTACT_US_STORE_NAME_ADDRESS';
UPDATE configuration SET configuration_title = '在庫わずかになったらメール送信',  configuration_description = '商品の在庫が水準を下回った際にメールを送信するかどうかを設定します。<br>・0= off<br>・1= on' WHERE `configuration_key` = 'SEND_LOWSTOCK_EMAIL';
...
UPDATE configuration SET configuration_title = 'テキストによる価格設定 - 空欄の場合は無料',  configuration_description = 'テキストによる価格設定の場合、空欄のままなら無料にするかどうかを設定します。<br>・0= off<br>・1= on' WHERE `configuration_key` = 'TEXT_SPACES_FREE';
UPDATE configuration SET configuration_title = 'Read Only属性の商品 -「カートに追加」ボタンの表示',  configuration_description = 'READONLY属性だけが設定された商品に「カートに追加」ボタンを表示しますか?<br>0= OFF<br>1= ON' WHERE `configuration_key` = 'PRODUCTS_OPTIONS_TYPE_READONLY_IGNORED';
UPDATE configuration SET configuration_title = 'GZip圧縮を使用する',  configuration_description = 'HTTP通信にGZip圧縮を使用してページを転送しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'GZIP_LEVEL';
...
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - VISA',  configuration_description = 'VISAを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_VISA';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - MasterCard',  configuration_description = 'MasterCardを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_MC';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - AmericanExpress',  configuration_description = 'AmericanExpressを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_AMEX';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - Diners Club',  configuration_description = 'Diners Clubを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_DINERS_CLUB';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - Discover Card',  configuration_description = 'Discover Cardを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_DISCOVER';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - JCB',  configuration_description = 'JCBを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_JCB';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - AUSTRALIAN BANKCARD',  configuration_description = 'AUSTRALIAN BANKCARDを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_AUSTRALIAN_BANKCARD';
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - SOLO',  configuration_description = 'SOLOを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_SOLO';
...
UPDATE configuration SET configuration_title = 'クレジットカード利用の可否 - Maestro',  configuration_description = 'Maestroを有効にしますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'CC_ENABLED_MAESTRO';
UPDATE configuration SET configuration_title = '利用可能なクレジットカード - 支払いページに表示',  configuration_description = '利用可能なクレジットカードを支払いページに表示しますか?<br>・0= off<br>・1= テキストを表示<br>・2= 画像を表示<br>【注意】クレジットカードの画像とテキストは、データベースとランゲージファイル内で定義されている必要があります。' WHERE `configuration_key` = 'SHOW_ACCEPTED_CREDIT_CARDS';
...
UPDATE configuration SET configuration_title = '商品情報 - 商品の属性画像の下にオプション値を表示',  configuration_description = '商品の属性画像の下にオプション名を表示しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'PRODUCT_IMAGES_ATTRIBUTES_NAMES';
UPDATE configuration SET configuration_title = '商品情報 - セール割引内容表示',  configuration_description = 'セールの割引率・値引額を表示しますか？<br>・0= off<br>・1= on' WHERE `configuration_key` = 'SHOW_SALE_DISCOUNT_STATUS';
...
UPDATE configuration SET configuration_title = '管理画面 - 商品登録時の数量欄デフォルト設定',  configuration_description = '新しい商品の登録画面で、「商品の数量欄の表示:」項目のデフォルト値の設定をします。<br>・0= off<br>・1= on<br>※on の状態で商品登録するとショップの画面ではカートに入れる数量入力欄を表示します。 off の場合は数量入力欄は表示されず「カートに追加」ボタンだけが表示され、カートには数量＝1で商品が追加されます。' WHERE `configuration_key` = 'PRODUCTS_QTY_BOX_STATUS';
UPDATE configuration SET configuration_title = '商品レビュー - 承認の要否',  configuration_description = '商品レビューの表示には承認が必要にしますか?<br>・0= off<br>・1= on<br>注意：レビューが非表示設定になっている場合は無視されます。' WHERE `configuration_key` = 'REVIEWS_APPROVAL';
UPDATE configuration SET configuration_title = 'METAタグ - TITLEタグへの商品型番表示',  configuration_description = 'TITLEタグに商品型番を表示しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'META_TAG_INCLUDE_MODEL';
UPDATE configuration SET configuration_title = 'METAタグ - TITLEタグへの商品価格表示',  configuration_description = 'TITLEタグに商品価格を表示しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'META_TAG_INCLUDE_PRICE';
...
UPDATE configuration SET configuration_title = '「こんな商品も購入しています」 - 横列あたりの表示点数',  configuration_description = '「こんな商品も買っています」の横列(Row)あたりの表示点数を設定します。<br>0= off または並び順を設定' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_COLUMNS_ALSO_PURCHASED_PRODUCTS';
UPDATE configuration SET configuration_title = '[前へ] [次へ] - ナビゲーションバーの位置',  configuration_description = '[前へ] [次へ] ナビゲーションバーの位置を設定します。<br>・0= off<br>・1= ページ上部<br>・2= ページ下部<br>・3= ページ上部・下部' WHERE `configuration_key` = 'PRODUCT_INFO_PREVIOUS_NEXT';
...
UPDATE configuration SET configuration_title = '[前へ] [次へ] ナビゲーション - 商品画像の表示',  configuration_description = '[前へ] [次へ] ボタンと対応する商品画像の表示を設定します。<br>・0= Off<br>・1= On' WHERE `configuration_key` = 'SHOW_PREVIOUS_NEXT_STATUS';
...
UPDATE configuration SET configuration_title = '商品登録0のカテゴリ - 表示・非表示',  configuration_description = '商品数が0のカテゴリを表示しますか?<br>・0 = off<br>・1 = on' WHERE `configuration_key` = 'CATEGORIES_COUNT_ZERO';
...
UPDATE configuration SET configuration_title = 'カテゴリ - トップページに表示',  configuration_description = 'カテゴリを常にトップページに表示しますか?<br>・0= off<br>・1= on<br>・Default category can be set to Top Level or a Specific Top Level' WHERE `configuration_key` = 'SHOW_CATEGORIES_ALWAYS';
...
UPDATE configuration SET configuration_title = 'フッタ - IPアドレスの表示・非表示',  configuration_description = '顧客のIPアドレスをフッタに表示しますか?<br>・0= off<br>・1= on<br>' WHERE `configuration_key` = 'SHOW_FOOTER_IP';
...
UPDATE configuration SET configuration_title = '「メンテナンス中」 オン/オフ',  configuration_description = '「メンテナンス中」の表示について設定します。<br>・true=on<br>・false=off' WHERE `configuration_key` = 'DOWN_FOR_MAINTENANCE';
...
UPDATE configuration SET configuration_title = '「メンテナンス予告(NOTICE PUBLIC)」-  オン/オフ',  configuration_description = 'ショップの「メンテナンス中」表示を出す前に告知を出しますか?<br>・true=on<br>・false=off<br>注意：「メンテナンス中」表示が有効になると、この設定は自動的にfalseに書き換えられます。' WHERE `configuration_key` = 'WARN_BEFORE_DOWN_FOR_MAINTENANCE';
...
UPDATE configuration SET configuration_title = '「メンテナンス中」- メンテナンスを開始した日時を表示',  configuration_description = 'ショップ管理者がいつ「メンテナンス中」表示をオンにしたか表示しますか?<br>・true=on<br>・false=off' WHERE `configuration_key` = 'DISPLAY_MAINTENANCE_TIME';
UPDATE configuration SET configuration_title = '「メンテナンス中」- メンテナンス期間を表示',  configuration_description = 'メンテナンスの期間を表示しますか?<br>・true=on<br>・false=off' WHERE `configuration_key` = 'DISPLAY_MAINTENANCE_PERIOD';
...
UPDATE configuration SET configuration_title = '商品画像を表示',  configuration_description = '商品画像を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_IMAGE';
UPDATE configuration SET configuration_title = '商品の数量を表示',  configuration_description = '商品数量を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_QUANTITY';
UPDATE configuration SET configuration_title = '「今すぐ買う」ボタンの表示',  configuration_description = '「今すぐ買う」ボタンを表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_BUY_NOW';
UPDATE configuration SET configuration_title = '商品名の表示',  configuration_description = '商品名を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_NAME';
UPDATE configuration SET configuration_title = '商品型番の表示',  configuration_description = '商品型番を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_MODEL';
UPDATE configuration SET configuration_title = '商品メーカーの表示',  configuration_description = '商品メーカーを表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_MANUFACTURER';
UPDATE configuration SET configuration_title = '商品価格の表示',  configuration_description = '商品価格を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_PRICE';
UPDATE configuration SET configuration_title = '商品重量の表示',  configuration_description = '商品の重量を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_WEIGHT';
UPDATE configuration SET configuration_title = '商品登録日の表示',  configuration_description = '商品登録日を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_DATE_ADDED';
UPDATE configuration SET configuration_title = '商品説明の表示',  configuration_description = '商品説明(最初の150文字)を表示しますか?<br>・0= off<br>・150= on' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_DESCRIPTION';
UPDATE configuration SET configuration_title = '商品の表示 - デフォルトの並び順',  configuration_description = '新着商品リストの表示のデフォルトの並び順は? デフォルト値は6です。<br>・1= 商品名<br>・2= 商品名(降順)<br>・3= 価格が安いものから商品名<br>・4= 価格が高いものから商品名<br>・5= 型番<br>・6= 商品登録日(降順)<br>・7= 商品登録日<br>・8= 商品順(Product Sort)<br>' WHERE `configuration_key` = 'PRODUCT_NEW_LIST_SORT_DEFAULT';
...
UPDATE configuration SET configuration_title = 'リスト内各商品への注文数量欄の表示とボタンの表示',  configuration_description = 'リスト内各商品にカートに入れる数量欄を表示するかどうかと、「選択商品をカートに追加」ボタンの表示位置を設定します。<br>0= off<br>1= 上部<br>2= 下部<br>3= 両方' WHERE `configuration_key` = 'PRODUCT_NEW_LISTING_MULTIPLE_ADD_TO_CART';
UPDATE configuration SET configuration_title = '新着商品に入荷待ち商品を加えますか？',  configuration_description = '新着商品一覧時に入荷待ち商品を加えますか？<br>0= off<br>1= on' WHERE `configuration_key` = 'SHOW_NEW_PRODUCTS_UPCOMING_MASKED';
UPDATE configuration SET configuration_title = '商品画像の表示',  configuration_description = '商品画像を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_IMAGE';
UPDATE configuration SET configuration_title = '商品数量の表示',  configuration_description = '商品数量を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_QUANTITY';
UPDATE configuration SET configuration_title = '「今すぐ買う」ボタンの表示',  configuration_description = '「今すぐ買う」ボタンを表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_BUY_NOW';
UPDATE configuration SET configuration_title = '商品名の表示',  configuration_description = '商品名を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_NAME';
UPDATE configuration SET configuration_title = '商品型番の表示',  configuration_description = '商品型番を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_MODEL';
UPDATE configuration SET configuration_title = '商品メーカーの表示',  configuration_description = '商品メーカーを表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_MANUFACTURER';
UPDATE configuration SET configuration_title = '商品価格の表示',  configuration_description = '商品価格を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_PRICE';
UPDATE configuration SET configuration_title = '商品重量の表示',  configuration_description = '商品重量を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_WEIGHT';
UPDATE configuration SET configuration_title = '商品登録日の表示',  configuration_description = '商品登録日を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_DATE_ADDED';
UPDATE configuration SET configuration_title = '商品説明の表示',  configuration_description = '商品説明(最初の150文字)を表示しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_DESCRIPTION';
UPDATE configuration SET configuration_title = '商品表示 - デフォルトの並び順',  configuration_description = 'おすすめ商品リストの表示のデフォルトの並び順は? デフォルト値は1です。<br>・1= 商品名<br>・2= 商品名(降順)<br>・3= 価格が安いものから、商品名<br>・4= 価格が高いものから、商品名<br>・5= 型番<br>・6= 商品登録日(降順)<br>・7= 商品登録日<br>・8= 商品順(Product Sort)' WHERE `configuration_key` = 'PRODUCT_FEATURED_LIST_SORT_DEFAULT';
...
UPDATE configuration SET configuration_title = 'リスト内各商品への注文数量欄の表示とボタンの表示',  configuration_description = 'リスト内各商品への数量欄の表示の有無と「選択した商品をカートに追加」ボタンの表示位置を設定します。<br>0= off<br>1= 上部<br>2= 下部<br>3= 両方' WHERE `configuration_key` = 'PRODUCT_FEATURED_LISTING_MULTIPLE_ADD_TO_CART';
UPDATE configuration SET configuration_title = '商品画像の表示',  configuration_description = '商品画像を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_IMAGE';
UPDATE configuration SET configuration_title = '商品数量の表示',  configuration_description = '商品数量を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_QUANTITY';
UPDATE configuration SET configuration_title = '「今すぐ買う」ボタンの表示',  configuration_description = '「今すぐ買う」ボタンを表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_BUY_NOW';
UPDATE configuration SET configuration_title = '商品名の表示',  configuration_description = '商品名を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_NAME';
UPDATE configuration SET configuration_title = '商品型番の表示',  configuration_description = '商品型番を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_MODEL';
UPDATE configuration SET configuration_title = '商品メーカーの表示',  configuration_description = '商品メーカーを表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_MANUFACTURER';
UPDATE configuration SET configuration_title = '商品価格の表示',  configuration_description = '商品価格を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_PRICE';
UPDATE configuration SET configuration_title = '商品重量の表示',  configuration_description = '商品重量を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_WEIGHT';
UPDATE configuration SET configuration_title = '商品登録日の表示',  configuration_description = '商品登録日を表示しますか?<br>・0= off<br>・1桁目：左か右か<br>・2・3桁目：表示項目内での並び順<br>・4桁目：表示後の改行(br)数<br>' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_DATE_ADDED';
UPDATE configuration SET configuration_title = '商品説明の表示',  configuration_description = '商品説明(最初の150文字)を表示しますか?<br>・0= off<br>・1= on' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_DESCRIPTION';
UPDATE configuration SET configuration_title = '商品表示 - デフォルトの並び順',  configuration_description = '全商品リストの表示のデフォルトの並び順は? デフォルト値は1です。<br>・1= 商品名<br>・2= 商品名(降順)<br>・3= 価格が安いものから、商品名<br>・4= 価格が高いものから、商品名<br>・5= 型番<br>・6= 商品登録日(降順)<br>・7= 商品登録日<br>・8= 商品順(Product Sort)' WHERE `configuration_key` = 'PRODUCT_ALL_LIST_SORT_DEFAULT';
...
UPDATE configuration SET configuration_title = 'リスト内各商品への注文数量欄の表示とボタンの表示',  configuration_description = 'リスト内各商品への数量欄の表示の有無と「選択した商品をカートに追加」ボタンの表示位置を設定します。<br>0= off<br>1= 上部<br>2= 下部<br>3= 両方' WHERE `configuration_key` = 'PRODUCT_ALL_LISTING_MULTIPLE_ADD_TO_CART';
UPDATE configuration SET configuration_title = '新着商品をトップページに表示する',  configuration_description = '新着商品をトップページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MAIN_NEW_PRODUCTS';
UPDATE configuration SET configuration_title = 'おすすめ商品をトップページに表示する',  configuration_description = 'おすすめ商品をトップページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MAIN_FEATURED_PRODUCTS';
UPDATE configuration SET configuration_title = '特価商品をトップページに表示する',  configuration_description = '特価商品をトップページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MAIN_SPECIALS_PRODUCTS';
UPDATE configuration SET configuration_title = '入荷予定商品をトップページに表示する',  configuration_description = '入荷予定商品をトップページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MAIN_UPCOMING';
UPDATE configuration SET configuration_title = '新着商品を商品カタログページに表示する - カテゴリ・サブカテゴリ共に<br>',  configuration_description = '新着商品を(トップレベル)カテゴリ・サブカテゴリ共に商品カタログページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_CATEGORY_NEW_PRODUCTS';
UPDATE configuration SET configuration_title = 'おすすめ商品を商品カタログページに表示する - カテゴリ・サブカテゴリ共に',  configuration_description = 'おすすめ商品を(トップレベル)カテゴリ・サブカテゴリ共に商品カタログページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_CATEGORY_FEATURED_PRODUCTS';
UPDATE configuration SET configuration_title = '特価商品を商品カタログページに表示する - カテゴリ・サブカテゴリ共に',  configuration_description = '特価商品を(トップレベル)カテゴリ・サブカテゴリ共に商品カタログページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_CATEGORY_SPECIALS_PRODUCTS';
UPDATE configuration SET configuration_title = '入荷予定商品を商品カタログページに表示する - カテゴリ・サブカテゴリ共に',  configuration_description = '入荷予定商品を(トップレベル)カテゴリ・サブカテゴリ共に商品カタログページに表示 しますか?<br>0= off<br>または表示順を数値(1～4)で設定してください。<br>' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_CATEGORY_UPCOMING';
UPDATE configuration SET configuration_title = '新着商品を商品カタログページに表示する - エラーページと「商品がありません」ページ',  configuration_description = '新着予定商品を商品カタログページに表示 しますか?<br>エラーページと「商品がありません」ページ<br>0= off<br>または順番を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MISSING_NEW_PRODUCTS';
UPDATE configuration SET configuration_title = 'おすすめ商品を商品カタログページに表示する - エラーページと「商品がありません」ページ',  configuration_description = 'おすすめ商品を商品カタログページに表示 しますか?<br>(エラーページと「商品がありません」ページ)<br>0= off<br>または順番を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MISSING_FEATURED_PRODUCTS';
UPDATE configuration SET configuration_title = '特価商品を商品カタログページに表示する - エラーページと「商品がありません」ページ',  configuration_description = '特価商品を商品カタログページに表示 しますか?<br>(エラーページと「商品がありません」ページ)<br>0= off<br>または順番を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MISSING_SPECIALS_PRODUCTS';
UPDATE configuration SET configuration_title = '入荷予定商品を商品カタログページに表示する - エラーページと「商品がありません」ページ',  configuration_description = '入荷予定商品を商品カタログページに表示 しますか?<br>(エラーページと「商品がありません」ページ)<br>0= off<br>または順番を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_MISSING_UPCOMING';
UPDATE configuration SET configuration_title = '新着商品を表示する - 商品リストの下部に',  configuration_description = '商品リストの下に新着商品を表示しますか?<br>0= off<br>または配置順を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_LISTING_BELOW_NEW_PRODUCTS';
UPDATE configuration SET configuration_title = 'おすすめ商品を表示する - 商品リストの下部に',  configuration_description = '商品リストの下におすすめ商品を表示しますか?<br>0= off<br>または配置順を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_LISTING_BELOW_FEATURED_PRODUCTS';
UPDATE configuration SET configuration_title = '特価商品を表示する - 商品リストの下部に',  configuration_description = '商品リストの下に特価商品を表示しますか?<br>0= off<br>または配置順を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_LISTING_BELOW_SPECIALS_PRODUCTS';
UPDATE configuration SET configuration_title = '入荷予定商品を表示する - 商品リストの下部に',  configuration_description = '商品リストの下に入荷予定商品を表示しますか?<br>0= off<br>または配置順を数値(1～4)で設定してください。' WHERE `configuration_key` = 'SHOW_PRODUCT_INFO_LISTING_BELOW_UPCOMING';
...
UPDATE configuration SET configuration_title = 'EZページ - [次へ][前へ]ボタン',  configuration_description = 'EZページのコンテンツ内[前へ][続ける][次へ]ボタンを表示しますか?<br>0=OFF (ボタンなし)<br>1=「続ける」を表示<br>2=「前へ」「続ける」「次へ」を表示<br>デフォルト：2' WHERE `configuration_key` = 'EZPAGES_SHOW_PREV_NEXT_BUTTONS';
...
UPDATE product_type_layout SET configuration_title = '追加された日付を表示', configuration_description = 'Display Date Added on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_INFO_DATE_ADDED';
...
UPDATE product_type_layout SET configuration_title = 'ショッピングカート内の数量を表示', configuration_description = 'Display Quantity in Current Shopping Cart on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_MUSIC_INFO_IN_CART_QTY';
UPDATE product_type_layout SET configuration_title = '在庫数を表示', configuration_description = 'Display Quantity in Stock on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_MUSIC_INFO_QUANTITY';
...
UPDATE product_type_layout SET configuration_title = '追加された日付を表示', configuration_description = 'Display Date Added on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_MUSIC_INFO_DATE_ADDED';
...
UPDATE product_type_layout SET configuration_title = '追加された日付を表示', configuration_description = 'Display Date Added on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_DOCUMENT_GENERAL_INFO_DATE_ADDED';
...
UPDATE product_type_layout SET configuration_title = 'ショッピングカート内の数量を表示', configuration_description = 'Display Quantity in Current Shopping Cart on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_DOCUMENT_PRODUCT_INFO_IN_CART_QTY';
UPDATE product_type_layout SET configuration_title = '在庫数を表示', configuration_description = 'Display Quantity in Stock on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_DOCUMENT_PRODUCT_INFO_QUANTITY';
...
UPDATE product_type_layout SET configuration_title = '追加された日付を表示', configuration_description = 'Display Date Added on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_DOCUMENT_PRODUCT_INFO_DATE_ADDED';
...
UPDATE product_type_layout SET configuration_title = 'ショッピングカート内の数量を表示', configuration_description = 'Display Quantity in Current Shopping Cart on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_FREE_SHIPPING_INFO_IN_CART_QTY';
UPDATE product_type_layout SET configuration_title = '在庫数を表示', configuration_description = 'Display Quantity in Stock on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_FREE_SHIPPING_INFO_QUANTITY';
...
UPDATE product_type_layout SET configuration_title = '追加された日付を表示', configuration_description = 'Display Date Added on Product Info 0= off 1= on' WHERE configuration_key = 'SHOW_PRODUCT_FREE_SHIPPING_INFO_DATE_ADDED';
