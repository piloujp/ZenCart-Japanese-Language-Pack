...
<form id="db_setup" name="db_setup" method="post" action="index.php?main_page=admin_setup" data-abide="ajax">
  ...
  <fieldset>
    <legend><?php echo TEXT_DATABASE_SETUP_JAPANESE_ADMIN; ?></legend>
    <div class="row">
      <div class="small-3 columns">
        <label class="inline" for="adminjp"><a href="#" class="hasHelpText" id="ADMINJP"><?php echo TEXT_DATABASE_SETUP_LOAD_JAPANESE_ADMIN; ?></a></label>
      </div>
      <div class="small-9 columns">
        <input type="checkbox" name="adminjp" id="adminjp" tabindex="5" <?php echo $install_japanese_admin ? 'checked' : ''; ?>><label class="inline" for="adminjp"><?php echo TEXT_DATABASE_SETUP_LOAD_JAPANESE_ADMIN_DESCRIPTION; ?></label>
      </div>
    </div>
  </fieldset>
  <fieldset>
