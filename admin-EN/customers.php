    ...
    <div class="container-fluid">
        ...
        if ($action == 'edit' || $action == 'update') {
            ...
            <div class="formArea">
                ...
                <div class="form-group">
                    <?php
                    echo zen_draw_label(ENTRY_FIRST_NAME_KANA, 'customers_firstname_kana', 'class="col-sm-3 control-label"'); ?>
                    <div class="col-sm-9 col-md-6">
                        <?php
                        echo zen_draw_input_field(
                ...
                <div class="form-group">
                    <?php
                    echo zen_draw_label(ENTRY_LAST_NAME_KANA, 'customers_lastname_kana', 'class="col-sm-3 control-label"'); ?>
                    <div class="col-sm-9 col-md-6">
                        <?php
                        echo zen_draw_input_field(
...
// Sort Listing
            switch ($_GET['list_order']) {
                ...
                case 'firstname-desc':
                    ...
                    break;
                case 'firstname_kana':
                    $disp_order = "c.customers_firstname_kana";
                    break;
                case 'firstname_kana-desc':
                    $disp_order = "c.customers_firstname_kana DESC";
                    break;
                case 'group-asc':
                ...
                case 'lastname-desc':
                    ...
                    break;
                case 'lastname_kana':
                    $disp_order = "c.customers_lastname_kana, c.customers_firstname_kana";
                    break;
                case 'lastname_kana-desc':
                    $disp_order = "c.customers_lastname_kana DESC, c.customers_firstname_kana";
                    break;
                case 'company':
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
                    <table class="table table-hover">
                        ...
                        <tr class="dataTableHeadingRow">
                            ...
                            <th class="dataTableHeadingContent">
                                <?php
                                echo(($_GET['list_order'] == 'lastname_kana' or $_GET['list_order'] == 'lastname_kana-desc') ? '<span class="SortOrderHeader">' . TABLE_HEADING_LASTNAME_KANA . '</span>' : TABLE_HEADING_LASTNAME_KANA); ?>
                                <br>
                                <a href="<?php
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(array('list_order', 'page')) . 'list_order=lastname_kana',
                                    'NONSSL'
                                ); ?>"><?php
                                    echo($_GET['list_order'] == 'lastname_kana' ? '<span class="SortOrderHeader">' . TEXT_ASC . '</span>' : '<span class="SortOrderHeaderLink">' . TEXT_ASC . '</span>'); ?></a>&nbsp;
                                <a href="<?php
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(array('list_order', 'page')) . 'list_order=lastname_kana-desc',
                                    'NONSSL'
                                ); ?>"><?php
                                    echo($_GET['list_order'] == 'lastname_kana-desc' ? '<span class="SortOrderHeader">' . TEXT_DESC . '</span>' : '<span class="SortOrderHeaderLink">' . TEXT_DESC . '</span>'); ?></a>
                            </th>
                            <th class="dataTableHeadingContent">
                                <?php
                            ...
                            <th class="dataTableHeadingContent">
                                <?php
                                echo(($_GET['list_order'] == 'firstname_kana' or $_GET['list_order'] == 'firstname_kana-desc') ? '<span class="SortOrderHeader">' . TABLE_HEADING_FIRSTNAME_KANA . '</span>' : TABLE_HEADING_FIRSTNAME_KANA); ?>
                                <br>
                                <a href="<?php
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(array('list_order', 'page')) . 'list_order=firstname_kana',
                                    'NONSSL'
                                ); ?>"><?php
                                    echo($_GET['list_order'] == 'firstname_kana' ? '<span class="SortOrderHeader">' . TEXT_ASC . '</span>' : '<span class="SortOrderHeaderLink">' . TEXT_ASC . '</span>'); ?></a>&nbsp;
                                <a href="<?php
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(array('list_order', 'page')) . 'list_order=firstname_kana-desc',
                                    'NONSSL'
                                ); ?>"><?php
                                    echo($_GET['list_order'] == 'firstname_kana-desc' ? '<span class="SortOrderHeader">' . TEXT_DESC . '</span>' : '<span class="SortOrderHeaderLink">' . TEXT_DESC . '</span>'); ?></a>
                            </th>
                            <?php
                            if (ACCOUNT_COMPANY === 'true') { ?>
                                <th class="dataTableHeadingContent">
...
//    zen_redirect(zen_href_link(FILENAME_CUSTOMERS, 'cID=' . $_GET['cID'] . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'NONSSL'));
                        ...
                        foreach ($customers as $result) {
                            ...
                            <td class="dataTableContent"><?php
                                echo $customer['customers_lastname_kana']; ?></td>
                            <td class="dataTableContent"><?php
                                echo $customer['customers_firstname']; ?></td>
                            <td class="dataTableContent"><?php
                                echo $customer['customers_firstname_kana']; ?></td>
                            <?php
                            if (ACCOUNT_COMPANY === 'true') { ?>
                                <td class="dataTableContent"><?php
