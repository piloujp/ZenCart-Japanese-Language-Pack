...
$define = [
    ...
    'TEXT_INSTRUCTIONS' => 'このページを使用して、「商品オプションの在庫」 プラグインによって管理されている商品に関連付けるテキスト ラベルを定義および管理します。商品に割り当てたラベルは、オプションの組み合わせが「在庫切れ」の場合に顧客に表示されます。特殊記号<b>[date]</b>を使用して、（オプションで）関連する株式関連の日付を挿入する場所を指定します。',
