...
$define = [
    ...
    'ADMIN_PLUGIN_MANAGER_DESCRIPTION_FOR_POSM' => 'このプラグインを使用すると、サイトで商品と属性の組み合わせ（「製品バリアント」または「属性別在庫」とも呼ばれます）に基づいて商品の在庫レベルとモデル番号を割り当てることができます。<em>注文編集</em><sup>5</sup>のサポートが追加されました。',
// POSM - configuration
