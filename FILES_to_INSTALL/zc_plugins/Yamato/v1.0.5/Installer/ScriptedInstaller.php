...
{
    private array $default_priceranks_headers = [
            'SHIPPING_RATES_DIM_ZONE' => ['60', '80', '100', '120', '140', '160', '180', '200'],
        ];
    ...
    private array $default_yamatocompact_headers = ['SHIPPING_RATES_ZONE_ONLY_TITLE' => ['SHIPPING_RATES_ZONE_ONLY_RATES']];
    ...
    protected function executeInstall()
    {
        ...
        $this->executeInstallerSql(
            ...
            VALUES
                ('Yamato', 'Takyubin', '" . $this->imple_date . "', NOW(), '" . json_encode($this->default_priceranks) . "', '" . json_encode($this->default_priceranks_headers) . "'),
                ('Yamato', 'CoolTakyubin', '" . $this->imple_date . "', NOW(), '" . json_encode($this->default_coolyamato_surcharge) . "', '" . json_encode($this->default_coolyamato_headers) . "'),
                ('Yamato', 'Compact', '" . $this->imple_yamatocompact_date . "', NOW(), '" . json_encode($this->default_yamatocompact_priceranks) . "', '" . json_encode($this->default_yamatocompact_headers) . "')
            ;"
        );
