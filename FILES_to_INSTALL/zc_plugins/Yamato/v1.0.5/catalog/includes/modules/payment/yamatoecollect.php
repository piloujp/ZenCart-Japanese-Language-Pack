...
// class methods
    ...
    {
        return [
            'MODULE_PAYMENT_YAMATOECOLLECT_STATUS',
            'MODULE_PAYMENT_YAMATOECOLLECT_ZONE',
            'MODULE_PAYMENT_YAMATOECOLLECT_LIMIT',
            'MODULE_PAYMENT_YAMATOECOLLECT_ORDER_STATUS_ID',
            'MODULE_PAYMENT_YAMATOECOLLECT_SORT_ORDER',
        ];
    }
}
