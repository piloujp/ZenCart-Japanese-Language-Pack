...
$define = [
    ...
    'TARIFS_PLUGIN_NOT_INSTALLED' => 'Inactive!',
    'TARIFS_NO_PLUGIN' => 'No plugin installed! At least one plugin must be installed to get data here!',
];
return $define;
