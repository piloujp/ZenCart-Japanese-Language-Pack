...
use Zencart\Plugins\Catalog\Sagawa\_Sagawa;

class sagawa extends ZenShipping
{
    /**
    ...
    **/
    public function __construct()
    {
        ...
        $this->sort_order = zen_config('MODULE_SHIPPING_SAGAWA_SORT_ORDER');
        if (null === $this->sort_order) {
            return;
        }

        $Pversion = zen_get_plugin_version('Sagawa');
        $this->icon = (!empty($Pversion)) ? HTTPS_SERVER . DIR_WS_CATALOG . 'zc_plugins/Sagawa/' . $Pversion . '/catalog/includes/templates/default/images/icons/shipping_sagawa.gif' : '';
        $this->tax_class = zen_config('MODULE_SHIPPING_SAGAWA_TAX_CLASS');
        $this->tax_basis = zen_config('MODULE_SHIPPING_SAGAWA_TAX_BASIS');
    ...
    **/
    public function update_status()
    {
        ...
        $this->checkEnabledForZone(zen_config('MODULE_SHIPPING_SAGAWA_ZONE'));
    ...
    **/
    public function check()
    {
        if (!isset($this->_check)) {
            $this->_check = (int)(zen_config('MODULE_SHIPPING_SAGAWA_STATUS') !== null);
        }
        return $this->_check;
    }
    ...
    **/
    ...
    {
        return [
            'MODULE_SHIPPING_SAGAWA_STATUS',
            'MODULE_SHIPPING_SAGAWA_CATEGORIES',
            'MODULE_SHIPPING_SAGAWA_CAT_LIST',
            'MODULE_SHIPPING_SAGAWA_PRODUCTS',
            'MODULE_SHIPPING_SAGAWA_PROD_LIST',
            'MODULE_SHIPPING_SAGAWA_HANDLING',
            'MODULE_SHIPPING_SAGAWA_MAX_WEIGHT',
            'MODULE_SHIPPING_SAGAWA_MAX_GIRTH',
            'MODULE_SHIPPING_SAGAWA_FREE_SHIPPING',
            'MODULE_SHIPPING_SAGAWA_OVER',
            'MODULE_SHIPPING_SAGAWA_TAX_CLASS',
            'MODULE_SHIPPING_SAGAWA_TAX_BASIS',
            'MODULE_SHIPPING_SAGAWA_ZONE',
