...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    private array $default_priceranks_headers = [
            'SHIPPING_RATES_DIM_ZONE' => ['60', '80', '100', '140', '160', '170', '180', '200', '220', '240', '260'],
        ];
    ...
    protected function executeInstall()
    {
        ...
        $this->executeInstallerSql(
            ...
            VALUES
                ('Sagawa', 'Express', '" . $this->imple_date . "', NOW(), '" . json_encode($this->default_priceranks) . "', '" . json_encode($this->default_priceranks_headers) . "');"
        );
