<?php
$define = [
    'MODULE_SHIPPING_SAGAWA_TEXT_TITLE' => '佐川急便、１－５日',
...
//bof constant configuration titles and descriptions for Sagawa Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_CATEGORIES' => '一部のカテゴリーで佐川急便配送方法を有効または無効にする',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_CATEGORIES' => '一部のカテゴリーに対して佐川急便配送を有効または無効にしますか？',
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_CAT_LIST' => '有効/無効カテゴリIDリスト',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_CAT_LIST' => '上記のオプションに応じて有効または無効にするカテゴリ ID のコンマ区切りリスト。',
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_PRODUCTS' => '一部の商品で佐川急便配送方法を有効または無効にする',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_PRODUCTS' => '一部の商品に対して佐川急便配送を有効または無効にしますか？',
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_PROD_LIST' => '有効/無効の商品IDリスト',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_PROD_LIST' => '上記のオプションに応じて有効または無効にする製品 ID のコンマ区切りリスト。',
