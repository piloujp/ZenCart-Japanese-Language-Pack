<?php
$define = [
    'MODULE_SHIPPING_SAGAWA_TEXT_TITLE' => 'Sagawa Express 1-5 jours',
...
//bof constant configuration titles and descriptions for Sagawa Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_CATEGORIES' => 'Activer ou désactiver la méthode d’expédition Sagawa pour certaines catégories',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_CATEGORIES' => 'Souhaitez-vous activer ou désactiver la méthode d’expédition Sagawa pour certaines catégories ?',
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_CAT_LIST' => 'Liste des identifiants des catégories à activer/désactiver',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_CAT_LIST' => 'Liste séparée par des virgules des identifiants de catégories à activer ou à désactiver, selon l’option ci-dessus.',
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_PRODUCTS' => 'Activer ou désactiver la méthode d’expédition Sagawa pour certains produits',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_PRODUCTS' => 'Souhaitez-vous activer ou désactiver la méthode d’expédition Sagawa pour certains produits ?',
    'CFGTITLE_MODULE_SHIPPING_SAGAWA_PROD_LIST' => 'Liste des identifiants de produits à activer/désactiver',
    'CFGDESC_MODULE_SHIPPING_SAGAWA_PROD_LIST' => 'Liste séparée par des virgules des identifiants de produits à activer ou à désactiver, selon l’option ci-dessus.',
