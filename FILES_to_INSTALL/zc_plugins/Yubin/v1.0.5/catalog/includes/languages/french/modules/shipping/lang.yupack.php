<?php
$define = [
    'MODULE_SHIPPING_YUPACK_TEXT_TITLE' => 'Yu-Pack 1-5 jours',
    ...
    'MODULE_SHIPPING_YUPACK_TEXT_NOTAVAILABLE' => 'Ce service n’est pas disponible pour la destination sélectionnée.',
//bof constant configuration titles and descriptions for YuPack Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_YUPACK_CATEGORIES' => 'Activer ou désactiver la méthode d’expédition Yu-Pack pour certaines catégories',
    'CFGDESC_MODULE_SHIPPING_YUPACK_CATEGORIES' => 'Souhaitez-vous activer ou désactiver la méthode d’expédition Yu-Pack pour certaines catégories ?',
    'CFGTITLE_MODULE_SHIPPING_YUPACK_CAT_LIST' => 'Liste des identifiants des catégories à activer/désactiver',
    'CFGDESC_MODULE_SHIPPING_YUPACK_CAT_LIST' => 'Liste séparée par des virgules des identifiants de catégories à activer ou à désactiver, selon l’option ci-dessus.',
    'CFGTITLE_MODULE_SHIPPING_YUPACK_PRODUCTS' => 'Activer ou désactiver la méthode d’expédition Yu-Pack pour certains produits',
    'CFGDESC_MODULE_SHIPPING_YUPACK_PRODUCTS' => 'Souhaitez-vous activer ou désactiver la méthode d’expédition Yu-Pack pour certains produits ?',
    'CFGTITLE_MODULE_SHIPPING_YUPACK_PROD_LIST' => 'Liste des identifiants de produits à activer/désactiver',
    'CFGDESC_MODULE_SHIPPING_YUPACK_PROD_LIST' => 'Liste séparée par des virgules des identifiants de produits à activer ou à désactiver, selon l’option ci-dessus.',
