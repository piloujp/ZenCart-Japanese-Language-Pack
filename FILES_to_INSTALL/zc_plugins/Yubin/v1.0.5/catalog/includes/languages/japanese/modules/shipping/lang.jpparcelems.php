...
//bof constant configuration titles and descriptions for jpParcelems Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_CATEGORIES' => '一部のカテゴリーでEMS配送方法を有効または無効にする',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_CATEGORIES' => '一部のカテゴリーに対してEMS配送を有効または無効にしますか？',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_CAT_LIST' => '有効/無効カテゴリIDリスト',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_CAT_LIST' => '上記のオプションに応じて有効または無効にするカテゴリ ID のコンマ区切りリスト。',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_PRODUCTS' => '一部の商品でEMS配送方法を有効または無効にする',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_PRODUCTS' => '一部の商品に対してEMS配送を有効または無効にしますか？',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_PROD_LIST' => '有効/無効の商品IDリスト',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_PROD_LIST' => '上記のオプションに応じて有効または無効にする製品 ID のコンマ区切りリスト。',
