...
//bof constant configuration titles and descriptions for jpParcelems Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_CATEGORIES' => 'Activer ou désactiver la méthode d\'expédition EMS pour certaines catégories',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_CATEGORIES' => 'Souhaitez-vous activer ou désactiver la méthode d\'expédition EMS pour certaines catégories ?',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_CAT_LIST' => 'Liste des identifiants des catégories à activer/désactiver',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_CAT_LIST' => 'Liste séparée par des virgules des identifiants de catégories à activer ou à désactiver, selon l\'option ci-dessus.',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_PRODUCTS' => 'Activer ou désactiver la méthode d\'expédition EMS pour certains produits',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_PRODUCTS' => 'Souhaitez-vous activer ou désactiver la méthode d\'expédition EMS pour certains produits ?',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELEMS_PROD_LIST' => 'Liste des identifiants de produits à activer/désactiver',
    'CFGDESC_MODULE_SHIPPING_JPPARCELEMS_PROD_LIST' => 'Liste séparée par des virgules des identifiants de produits à activer ou à désactiver, selon l\'option ci-dessus.',
