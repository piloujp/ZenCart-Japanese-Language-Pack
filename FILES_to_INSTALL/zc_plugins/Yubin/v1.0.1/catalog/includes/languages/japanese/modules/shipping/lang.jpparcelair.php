...
//bof constant configuration titles and descriptions for jpParcelair Shipping
    ...
    'CFGTITLE_MODULE_SHIPPING_JPPARCELAIR_CATEGORIES' => '一部のカテゴリーで小包郵便物（航空小包）配送方法を有効または無効にする',
    'CFGDESC_MODULE_SHIPPING_JPPARCELAIR_CATEGORIES' => '一部のカテゴリーに対して小包郵便物（航空小包）配送を有効または無効にしますか？',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELAIR_CAT_LIST' => '有効/無効カテゴリIDリスト',
    'CFGDESC_MODULE_SHIPPING_JPPARCELAIR_CAT_LIST' => '上記のオプションに応じて有効または無効にするカテゴリ ID のコンマ区切りリスト。',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELAIR_PRODUCTS' => '一部の商品で小包郵便物（航空小包）配送方法を有効または無効にする',
    'CFGDESC_MODULE_SHIPPING_JPPARCELAIR_PRODUCTS' => '一部の商品に対して小包郵便物（航空小包）配送を有効または無効にしますか？',
    'CFGTITLE_MODULE_SHIPPING_JPPARCELAIR_PROD_LIST' => '有効/無効の商品IDリスト',
    'CFGDESC_MODULE_SHIPPING_JPPARCELAIR_PROD_LIST' => '上記のオプションに応じて有効または無効にする製品 ID のコンマ区切りリスト。',
