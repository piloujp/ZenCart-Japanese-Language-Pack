...
class jpparcelems extends ZenShipping
{
    ...
    **/
    public function install(): void
    {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Enable/Disable categories IDs list', 'MODULE_SHIPPING_JPPARCELEMS_CAT_LIST', '', 'Comma separated list of categoies IDs to be enables or disabled, depending on above option.', '6', '0', now())");
