...
class letterpacklite extends ZenShipping
{
    ...
    **/
    ...
    public function install(): void
    {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable or Disable Letter Pack Lite shipping method for some categories', 'MODULE_SHIPPING_LETTERPACKLITE_CATEGORIES', 'Disable', 'Do you want to enable or disable Letter Pack Lite shipping for some categories?', '6', '0', 'zen_cfg_select_option(array(\'Enable\', \'Disable\'), ', now())");
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable or Disable Letter Pack Lite shipping method for some products', 'MODULE_SHIPPING_LETTERPACKLITE_PRODUCTS', 'Disable', 'Do you want to enable or disable Letter Pack Lite shipping for some products?', '6', '0', 'zen_cfg_select_option(array(\'Enable\', \'Disable\'), ', now())");
