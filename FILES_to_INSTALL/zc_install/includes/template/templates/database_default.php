...
<form id="db_setup" name="db_setup" method="post" action="index.php?main_page=admin_setup" class="needs-validation">
    ...
    <fieldset class="border rounded p-3 mt-2">
        <legend><?= TEXT_DATABASE_SETUP_ENGLISH_ADMIN ?></legend>
        <div class="row mb-2">
            <div class="col-sm-5 col-lg-3">
                <label class="col-form-label" for="adminen">
                    <a href="#" class="hasHelpText icon-link" id="ADMINEN">
                        <?= TEXT_DATABASE_SETUP_LOAD_ENGLISH_ADMIN ?>
                        <i class="bi-question-circle"></i>
                    </a>
                </label>
            </div>
            <div class="col-xs-7 col-md-6">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="adminen" id="adminen" tabindex="5" <?= $install_english_admin ? 'checked' : '' ?>>
                    <label class="form-check-label" for="adminen"><?= TEXT_DATABASE_SETUP_LOAD_ENGLISH_ADMIN_DESCRIPTION ?></label>
                </div>
            </div>
        </div>
    </fieldset>
