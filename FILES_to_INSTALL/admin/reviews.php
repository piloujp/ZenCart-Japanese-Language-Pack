        ...
        <div class="row">
          <div class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-md-6">
                <span class="form-control" style="border:none; -webkit-box-shadow: none"><?php echo nl2br(zen_output_string_protected(zen_trunc_string($rInfo->reviews_text, 100))); ?></span>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-3">
