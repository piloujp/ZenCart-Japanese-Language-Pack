...
if (!empty($action)) {
    switch ($action) {
        ...
        case 'update':
            ...
            $customers_firstname_kana = zen_db_prepare_input(zen_sanitize_string($_POST['customers_firstname_kana'] ?? ''));
            ...
            if ($error === false) {
                $sql_data_array = [
                    ...
                    ['fieldName' => 'customers_firstname_kana', 'value' => $customers_firstname_kana, 'type' => 'stringIgnoreNull'],
                    ['fieldName' => 'customers_lastname', 'value' => $customers_lastname, 'type' => 'stringIgnoreNull'],
                    ['fieldName' => 'customers_lastname_kana', 'value' => $customers_lastname_kana, 'type' => 'stringIgnoreNull'],
                ...
                $sql_data_array = [
                    ...
                    ['fieldName' => 'entry_firstname_kana', 'value' => $customers_firstname_kana, 'type' => 'stringIgnoreNull'],
                    ['fieldName' => 'entry_lastname', 'value' => $customers_lastname, 'type' => 'stringIgnoreNull'],
                    ['fieldName' => 'entry_lastname_kana', 'value' => $customers_lastname_kana, 'type' => 'stringIgnoreNull'],
                    ...
                    ['fieldName' => 'entry_telephone', 'value' => $entry_telephone, 'type' => 'stringIgnoreNull'],
                    ['fieldName' => 'entry_fax', 'value' => $entry_fax, 'type' => 'stringIgnoreNull'],
                ];
...
?>
            ...
            <div class="form-group">
                <?= zen_draw_label(ENTRY_FIRST_NAME_KANA, 'customers_firstname_kana', 'class="col-sm-3 control-label"') ?>
                <div class="col-sm-9 col-md-6">
                    <?= zen_draw_input_field(
                        'customers_firstname_kana',
                        htmlspecialchars(
                            $cInfo->customers_firstname_kana,
                            ENT_COMPAT,
                            CHARSET,
                            true
                        ),
                        zen_set_field_length(
                            ...
                            'customers_firstname_kana',
                            50
                        ) . ' class="form-control" id="customers_firstname_kana" minlength="' . zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') . '"'
                    ) ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <?= zen_draw_label(ENTRY_LAST_NAME_KANA, 'customers_lastname_kana', 'class="col-sm-3 control-label"') ?>
                 <div class="col-sm-9 col-md-6">
                    <?= zen_draw_input_field(
                        'customers_lastname_kana',
                        htmlspecialchars(
                            $cInfo->customers_lastname_kana,
                            ENT_COMPAT,
                            CHARSET,
                            true
                        ),
                        zen_set_field_length(
                            ...
                            'customers_lastname_kana',
                            50
                        ) . ' class="form-control" id="customers_lastname_kana" minlength="' . zen_config('ENTRY_LAST_NAME_MIN_LENGTH') . '"'
                    ) ?>
                </div>
            </div>
<?php
...
?>
            ...
            <div class="form-group">
                <?= zen_draw_label(ENTRY_TELEPHONE_NUMBER, 'entry_telephone', 'class="col-sm-3 control-label"') ?>
                <div class="col-sm-9 col-md-6">
                    <?= zen_draw_input_field(
                        'entry_telephone',
                        htmlspecialchars(
                        ...
                        zen_set_field_length(
                            ...
                            'entry_telephone',
                            15
                        ) . ' class="form-control" id="entry_telephone" minlength="' . zen_config('ENTRY_TELEPHONE_MIN_LENGTH') . '"',
...
?>
            <div class="form-group">
                <?= zen_draw_label(ENTRY_FAX_NUMBER, 'entry_fax', 'class="col-sm-3 control-label"') ?>
                <div class="col-sm-9 col-md-6">
<?php
        if ($processed === true) {
...
?>
                    <h3 class="addressBookDefaultName">
                        <?= !empty($addresses['firstname_kana']) ? '<small>' . $addresses['firstname_kana'] . '</small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' : '' ?>
                        <?= !empty($addresses['lastname_kana']) ? '&nbsp;<small>' . $addresses['lastname_kana'] . '</small><br>' : '' ?>
                    ...
                    <address>
                        ...
                        <?= !empty($addresses['fax']) ? '<br><small>' . ENTRY_FAX_NUMBER . $addresses['fax'] . '</small>' : '' ?>
                    </address>
...
// Sort Listing
    $disp_order = match ($_GET['list_order']) {
        ...
        'firstname_kana' => "c.customers_firstname_kana",
        'firstname_kana-desc' => "c.customers_firstname_kana DESC",
        ...
        'lastname_kana' => "c.customers_lastname_kana, c.customers_firstname_kana",
        'lastname_kana-desc' => "c.customers_lastname_kana DESC, c.customers_firstname_kana",
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
                    <table class="table table-hover" role="listbox">
                        ...
                        <tr class="dataTableHeadingRow">
                            ...
                            <th class="dataTableHeadingContent">
                                <?= (($_GET['list_order'] === 'lastname_kana' || $_GET['list_order'] === 'lastname_kana-desc') ?
                                    '<span class="SortOrderHeader">' . TABLE_HEADING_LASTNAME_KANA . '</span>' :
                                    TABLE_HEADING_LASTNAME_KANA) ?>
                                <br>
                                <a href="<?= zen_href_link(FILENAME_CUSTOMERS, $list_order_params . 'list_order=lastname_kana') ?>">
                                    <?= ($_GET['list_order'] === 'lastname_kana') ?
                                        '<span class="SortOrderHeader">' . TEXT_ASC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_ASC . '</span>' ?>
                                </a>&nbsp;
                                <a href="<?= zen_href_link(FILENAME_CUSTOMERS, $list_order_params . 'list_order=lastname_kana-desc') ?>">
                                    <?= ($_GET['list_order'] === 'lastname_kana-desc') ?
                                        '<span class="SortOrderHeader">' . TEXT_DESC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_DESC . '</span>' ?>
                                </a>
                            </th>
                            ...
                            <th class="dataTableHeadingContent">
                                <?= ($_GET['list_order'] === 'firstname_kana' || $_GET['list_order'] === 'firstname_kana-desc') ?
                                    '<span class="SortOrderHeader">' . TABLE_HEADING_FIRSTNAME_KANA . '</span>' :
                                    TABLE_HEADING_FIRSTNAME_KANA ?>
                                <br>
                                <a href="<?= zen_href_link(FILENAME_CUSTOMERS, $list_order_params . 'list_order=firstname_kana') ?>">
                                    <?= ($_GET['list_order'] === 'firstname_kana') ?
                                        '<span class="SortOrderHeader">' . TEXT_ASC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_ASC . '</span>' ?>
                                </a>&nbsp;
                                <a href="<= zen_href_link(FILENAME_CUSTOMERS, $list_order_params . 'list_order=firstname-desc') ?>">
                                    <?= ($_GET['list_order'] === 'firstname_kana-desc') ?
                                        '<span class="SortOrderHeader">' . TEXT_DESC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_DESC . '</span>' ?>
                                </a>
                            </th>
...
<?php
    ...
    if (!empty($_GET['search'])) {
        ...
        $keyword_search_fields = [
            ...
            'c.customers_lastname_kana',
            'c.customers_firstname',
            'c.customers_firstname_kana',
