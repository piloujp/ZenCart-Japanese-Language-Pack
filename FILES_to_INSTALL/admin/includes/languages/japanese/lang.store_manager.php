...
$define = [
    ...
    'SUCCESS_PRODUCT_UPDATE_PRODUCTS_VIEWED' => 'すべての商品閲覧履歴を<strong>削除</strong>しました。',
    ...
    'TEXT_INFO_PRODUCTS_VIEWED_UPDATE' => '<strong>全ての商品閲覧履歴をリセット</strong><br>商品の閲覧回数のカウントを０にリセットします',
    'TEXT_INFO_PRODUCTS_ORDERED_UPDATE' => '<strong>全ての商品の注文回数をリセット</strong><br>商品の注文回数のカウントを０にリセットします',
    ...
    'TEXT_INFO_SET_NEXT_ORDER_NUMBER' => '<strong>次の注文番号を設定します</strong><br>注意：%uより大きくなければなりません。',
