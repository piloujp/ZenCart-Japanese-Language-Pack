...
$define = [
    ...
    'TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED' => '警告: 管理者設定が「' . zen_config('STORE_NAME') . '」で変更されました',
    'TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED' => 'これは、管理設定に変更が加えられたことをお知らせする「' . zen_config('STORE_NAME') . '」からの自動メールです。' . "\n\n" . '注意：管理画面の [%1$s] モジュールの設定が、Zen Cart管理者ユーザー%2$sによって変更されました。' . "\n\n" . 'もし、この変更に記憶がなかった場合は、すぐに設定を変更された方がいいでしょう。' . "\n\n" . 'この変更が周知のことであれば、このメールは無視しても構いません。',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED' => 'これは、管理設定に変更が加えられたことをお知らせする「' . zen_config('STORE_NAME') . '」からの自動メールです。' . "\n\n" . '注意：管理画面の設定が変更されました。[%1$s] モジュールがZen Cart管理者ユーザー%2$sによってインストールされました。' . "\n\n" . 'もし、この変更に記憶がなかった場合は、すぐに設定を変更された方がいいでしょう。' . "\n\n" . 'この変更が周知のことであれば、このメールは無視しても構いません。',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED' => 'これは、管理設定に変更が加えられたことをお知らせする「' . zen_config('STORE_NAME') . '」からの自動メールです。' . "\n\n" . '注意：管理画面の設定が変更されました。 [%1$s] モジュールがZen Cart管理者ユーザー%2$sによってアンインストールされました。' . "\n\n" . 'もし、この変更に記憶がなかった場合は、すぐに設定を変更された方がいいでしょう。' . "\n\n" . 'この変更が周知のことであれば、このメールは無視しても構いません。',
