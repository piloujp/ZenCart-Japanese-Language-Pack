...
*/
$define = [
    'HEADING_TITLE' => '顧客グループ',
    'TABLE_HEADING_GROUP_NAME' => 'グループ名',
    'TABLE_HEADING_GROUP_CUSTOMER_COUNT' => '顧客数',
    'TABLE_HEADING_GROUP_COMMENTS' => 'コメント/説明',
    'TEXT_HEADING_ADD_GROUP' => 'グループを追加',
    'TEXT_HEADING_EDIT_GROUP' => 'グループを編集',
    'TEXT_HEADING_DELETE_GROUP' => 'グループを削除',
    'TEXT_NO_GROUPS_FOUND' => 'グループが見つかりません。[挿入] をクリックして作成します。',
