                    ...
                    <div class="col-sm-4">
                        <table class="table" id="addressCustomer">
                            <tr>
                                ...
                                <td><?= zen_address_format($order->customer['format_id'], $order->customer, 1, '', '<br>')
                                    . (!empty($order->customer['name_kana']) ? '<br><small>' . ENTRY_NAME_KANA . $order->customer['name_kana'] . '</small>' : '') ?>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                    ...
                    <div class="col-sm-4">
                        <table class="table" id="addressBilling">
                            <tr>
                                ...
                                <td><?= zen_address_format($order->billing['format_id'], $order->billing, 1, '', '<br>')
                                    . (!empty($order->billing['name_kana']) ? '<br><small>' . ENTRY_NAME_KANA . $order->billing['name_kana'] . '</small>' : '')
                                    . (!empty($order->billing['telephone']) ? '<br><small>' . ENTRY_TELEPHONE_NUMBER . $order->billing['telephone'] . '</small>' : '')
                                    . ((!empty($order->delivery['fax']) && $order->delivery['fax'] != $order->delivery['telephone']) ? '<br><small>' . ENTRY_FAX_NUMBER . $order->delivery['fax'] . '</small>' : '') ?>
                                </td>
                            </tr>
                            <tr>
