...
class order extends base
{
    ...
    public function create(array $zf_ot_modules): ?int
    {
        ...
        $sql_data_array = [
            ...
            'customers_name' => ($this->customer['country']['id'] == $japan_id) ? $this->customer['lastname'] . ' ' . $this->customer['firstname'] : $this->customer['firstname'] . ' ' . $this->customer['lastname'],
            ...
            'customers_state' => $_SESSION['language'] === 'japanese' && $this->customer['country']['title'] === 'Japan' ? $this->customer['state_code'] : $this->customer['state'],
            ...
            'delivery_name' => ($this->delivery['country']['id'] == $japan_id) ? $this->delivery['lastname'] . ' ' . $this->delivery['firstname'] : $this->delivery['firstname'] . ' ' . $this->delivery['lastname'],
            ...
            'delivery_state' => $_SESSION['language'] === 'japanese' && $this->delivery['country']['title'] === 'Japan' ? $this->delivery['state_code'] : $this->delivery['state'],
            'delivery_country' => $this->delivery['country']['title'],
            'delivery_address_format_id' => (int)$this->delivery['format_id'],
            'billing_name' => ($this->billing['country']['id'] == $japan_id) ? $this->billing['lastname'] . ' ' . $this->billing['firstname'] : $this->billing['firstname'] . ' ' . $this->billing['lastname'],
            ...
            'billing_state' => $_SESSION['language'] === 'japanese' && $this->billing['country']['title'] === 'Japan' ? $this->billing['state_code'] : $this->billing['state'],
    ...
    private static function getAddress(array $customerAddresses, int $arrayKey): array
    {
        ...
        return [
            ...
            'firstname_kana' => $address['firstname_kana'],
            'lastname_kana' => $address['lastname_kana'],
