...
// MODULE_SHIPPING_STOREPICKUP_MULTIPLE_WAYS 定義の内容は、名前が変更されているだけで、管理の配送モジュールの設定にある複数の場所と同じである必要があります。
// 一般的な形式は次のとおりです：
// "Location One, 5.00; Location Two, 3.50; Location Three, 0.00"
// "Location One, Location Two, Location Three"
// または、言語に関係なく、単に管理で定義されているのと同じテキストを使用する場合は空白のままにします。
// ヒント：デフォルト言語の場合は、これを空白のままにしておく必要があります。そうしないと、「管理設定」フィールドは使用されません。
