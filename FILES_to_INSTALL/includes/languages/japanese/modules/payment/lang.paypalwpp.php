...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALWPP_FUNDING_ERROR' => 'お支払い資金に問題; Paypal.com サイトから直接' . zen_config('STORE_OWNER_EMAIL_ADDRESS') . 'に対してお支払いを行ってください。',
    ...
    'MODULE_PAYMENT_PAYPALWPP_TEXT_JS_CC_OWNER' => '* カード名義は最低 ' . zen_config('CC_OWNER_MIN_LENGTH') . ' 文字以上必要です。\n',
    'MODULE_PAYMENT_PAYPALWPP_TEXT_JS_CC_NUMBER' => '* カード番号は最低 ' . zen_config('CC_NUMBER_MIN_LENGTH') . ' 文字以上必要です。\n',
...
if (IS_ADMIN_FLAG === true) {
    ...
    $define['MODULE_PAYMENT_PAYPALWPP_TEXT_ADMIN_DESCRIPTION'] = '<strong>PayPalエクスプレスチェックアウト</strong>%s<br>' . (substr($define['MODULE_PAYMENT_PAYPALWPP_MODULE_MODE'], 0, 7) == 'Payflow' ? '<a href="https://manager.paypal.com/loginPage.do?partner=ZenCart" rel="noreferrer noopener" target="_blank">PayPalアカウントを設定</a>' : '<a href="https://www.paypal.com" rel="noopener" target="_blank">PayPalアカウントを設定</a>') . '<br><br><font color="green">設定手順：</font><br><span class="alert">1. </span><a href="https://www.zen-cart.com/partners/paypal-ec" rel="noopener" target="_blank">ここをクリックして PayPal に新規アカウント登録。</a><br>' .
        (zen_config('MODULE_PAYMENT_PAYPALWPP_STATUS') !== null ? '' : '... 次に上部の『インストール』をクリックして PayPalエクスプレスチェックアウトを有効にします。<br><a href="https://www.zen-cart.com/getpaypal" rel="noopener" target="_blank">さらに詳細なヘルプをご希望の場合には、こちらの FAQ をご利用ください</a><br>') .
