...
$define = [
    ...
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_OWNER' => '* カード名義は' . zen_config('CC_OWNER_MIN_LENGTH') . '文字以上必要です。\n',
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_NUMBER' => '* カード番号は' . zen_config('CC_NUMBER_MIN_LENGTH') . '文字以上必要です。\n',
