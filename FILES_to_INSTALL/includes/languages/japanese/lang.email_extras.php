...
$define = [
    ...
    'EMAIL_ORDER_MESSAGE' => '',
    'EMAIL_FOOTER_COPYRIGHT' => 'Copyright (c) ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '">' . zen_config('STORE_NAME') . '</a>. Powered by <a href="https://www.zen-cart.com" target="_blank">Zen Cart</a>',
    'TEXT_UNSUBSCRIBE' => "\n\nメールマガジンの購読を解除される場合は、こちらのリンクをクリックして下さい：\n",
    'EMAIL_ADVISORY' => '-----' . "\n" . '「<strong>重要：</strong>お客様の個人情報保護、および迷惑行為防止のために' . "\n" . '当ショップを経由して送信されるメールはショップ管理者が' . "\n" . '通信記録として保存しています。' . "\n" . 'もしこのメールにお心当たりがないようでしたら、' . "\n" . '大変お手数ですがメールにて' . zen_config('STORE_OWNER_EMAIL_ADDRESS') . "\n" .'までご連絡くださいますようお願いいたします。」' . "\n\n",
