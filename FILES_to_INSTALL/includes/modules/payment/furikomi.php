...
// class methods
    ...
    function install()
    {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Bank Account No.', 'MODULE_PAYMENT_FURIKOMI_ACCNUM', '1234567', 'Bank Account No.', '6', '1', now());");
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Account type', 'MODULE_PAYMENT_FURIKOMI_ACCTYPE', '普通', 'Account type: Standard(普).', '6', '1', 'zen_cfg_select_option(array(\'普通\', \'当座\'), ', now());");
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('SWIFT Code.', 'MODULE_PAYMENT_FURIKOMI_SWIFT', 'ABCDEFGH', 'SWIFT Code.', '6', '1', now());");
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Second Bank Account No.', 'MODULE_PAYMENT_FURIKOMI_ACCNUM2', '1234567', 'Bank Account No.', '6', '1', now());");
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Second Bank Account type', 'MODULE_PAYMENT_FURIKOMI_ACCTYPE2', '普通', 'Account type: Standard(普).', '6', '1', 'zen_cfg_select_option(array(\'普通\', \'当座\'), ', now());");
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Second Bank SWIFT Code.', 'MODULE_PAYMENT_FURIKOMI_SWIFT2', 'ABCDEFGH', 'SWIFT Code.', '6', '1', now());");
