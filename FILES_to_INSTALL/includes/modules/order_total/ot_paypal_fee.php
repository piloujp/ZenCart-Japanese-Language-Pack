...
//      $this->sort_order = MODULE_ORDER_TOTAL_PAYPAL_SORT_ORDER;
    ...
    function install() {
		...
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Fee for 300 000 to 1 000 000JPY in Japan', 'MODULE_ORDER_TOTAL_PAYPAL_FEE300JP', '3.4', 'PayPal fee in % for payment between 300 001 and 1 000 000 JPY in Japan', '6', '3', now())");
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Fee for 300 000 to 1 000 000JPY', 'MODULE_ORDER_TOTAL_PAYPAL_FEE300', '3.9', 'PayPal fee in % for payment between 300 001 and 1 000 000 JPY', '6', '3', now())");
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Fee for 1 000 000 to 10 000 0000JPY in Japan', 'MODULE_ORDER_TOTAL_PAYPAL_FEE1000JP', '3.2', 'PayPal fee in % for payment between 1 000 001 and 10 000 000 JPY in Japan', '6', '3', now())");
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Fee for 1 000 000 to 10 000 0000JPY', 'MODULE_ORDER_TOTAL_PAYPAL_FEE1000', '3.7', 'PayPal fee in % for payment between 1 000 001 and 10 000 000 JPY', '6', '3', now())");
