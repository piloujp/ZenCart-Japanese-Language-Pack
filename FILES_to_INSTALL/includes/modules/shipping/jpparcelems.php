...
*/
  ...
  function install() {
    ...
    //　Japanese
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('マルチボックス化を有効にする', 'MODULE_SHIPPING_JPPARCELEMS_MULTIBOX', 'None', '制限に達したときに新しい区画を追加しますか？何に基づいて？オプションは次のとおりです。<br>None - マルチボクシングなし<br>Weight - 重量制限に基づく新しいボックス', '6', '0', 'zen_cfg_select_option(array(\'None\', \'Weight\'), ', now())");
    ...
    // English
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable multi-boxing for this Method', 'MODULE_SHIPPING_JPPARCELEMS_MULTIBOX', 'None', 'Do you want to add new parcels when limit is reached and on what basis? Options are:<br>None - No multi-boxing<br>Weight - New boxes based on weight limit', '6', '0', 'zen_cfg_select_option(array(\'None\', \'Weight\'), ', now())");
   ...
   */
  function keys() {
    return array('MODULE_SHIPPING_JPPARCELEMS_STATUS', 'MODULE_SHIPPING_JPPARCELEMS_MULTIBOX', 'MODULE_SHIPPING_JPPARCELEMS_HANDLING', 'MODULE_SHIPPING_JPPARCELEMS_MAX_WEIGHT', 'MODULE_SHIPPING_JPPARCELEMS_FREE_SHIPPING', 'MODULE_SHIPPING_JPPARCELEMS_OVER', 'MODULE_SHIPPING_JPPARCELEMS_ZONE', 'MODULE_SHIPPING_JPPARCELEMS_SORT_ORDER');
  }
}
