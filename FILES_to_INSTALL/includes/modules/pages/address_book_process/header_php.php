...
if (isset($_POST['action']) && (($_POST['action'] == 'process') || ($_POST['action'] == 'update'))) {
  ...
  if (strlen($entry_telephone) < zen_config('ENTRY_TELEPHONE_MIN_LENGTH')) {
      $error = true;
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
  ...
  $entry->fields['entry_firstname_kana'] = '';
  $entry->fields['entry_lastname'] = '';
  $entry->fields['entry_lastname_kana'] = '';
  ...
  $entry->fields['entry_telephone'] = '';
  $entry->fields['entry_fax'] = '';
}
/*
