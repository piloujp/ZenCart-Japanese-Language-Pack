...
<?php echo zen_draw_input_field('firstname_kana', $account->fields['customers_firstname_kana'], 'id="firstname_kana" placeholder="' . ENTRY_FIRST_NAME_KANA_TEXT . '"' . ((int)zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') > 0 ? ' required' : '')); ?>
<br class="clearBoth">
<?php } ?>
...
<?php echo zen_draw_input_field('lastname_kana', $account->fields['customers_lastname_kana'], 'id="lastname_kana" placeholder="' . ENTRY_LAST_NAME_KANA_TEXT . '"' . ((int)zen_config('ENTRY_LAST_NAME_MIN_LENGTH') > 0 ? ' required' : '')); ?>
<br class="clearBoth">
<?php } ?>
