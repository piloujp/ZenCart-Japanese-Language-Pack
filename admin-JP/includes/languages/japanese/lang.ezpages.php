...
$define = [
    ...
    'TEXT_ALT_URL_EXPLAIN' => '内部リンクURLが指定されるとHTML コンテンツは無視され、内部リンクはリンクとして使用されるURLに変換されます。<br>例: index.php?main_page=reviews<br>マイページの例: index.php?main_page=account （マイページですので ページはSSLです: はYesにチェックを入れてください。）',
    'TEXT_ALT_URL_EXTERNAL' => '外部リンク URL:',
    'TEXT_ALT_URL_EXTERNAL_EXPLAIN' => '外部リンクURLが指定されるとHTML コンテンツは無視され、外部リンクはリンクとして使用されるURLに変換されます。<br>外部リンクへの例: http://www.sashbox.net',
