...
$define = [
    ...
    'TEXT_COUPON_HELP_DATE' => '<p><p>このクーポンは%1$sから%2$sまでの間、有効です</p></p>',
    'HTML_COUPON_HELP_DATE' => '<p><p>このクーポンは%1$sから%2$sまでの間、有効です</p></p>',
    'CUSTOMER_ID' => '顧客 ID',
    'CUSTOMER_NAME' => '顧客名',
    'REDEEM_DATE' => '引き換え日付',
    'IP_ADDRESS' => 'IP アドレス',
    ...
    'COUPON_REFERRER_EXISTS' => 'クーポン \'%1$s\'（id %2$d）は参照元 \'%3$s\' にすでに存在します',
    ...
    'TEXT_CONFIRM_DELETE_DUPLICATE' => '指定されたベースクーポンコードに前方一致する全てのクーポンをグループで削除します。<br>例：<strong>%1$s</strong> を指定した場合、<strong>%2$s</strong>から始まるすべてのクーポンが削除対象となります。',
