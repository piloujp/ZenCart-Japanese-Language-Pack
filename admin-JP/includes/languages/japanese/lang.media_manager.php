...
$define = [
    'HEADING_TITLE_MEDIA_MANAGER' => 'メディアコレクション(アルバム)',
    'TABLE_HEADING_MEDIA' => 'アルバム名',
    'TEXT_HEADING_NEW_MEDIA_COLLECTION' => '新しいアルバム',
    ...
    'TEXT_HEADING_DELETE_MEDIA_COLLECTION' => 'アルバムを削除する',
    'TEXT_DELETE_INTRO' => 'このアルバムを本当に削除しますか?',
    'TEXT_DISPLAY_NUMBER_OF_MEDIA' => ' (挙げられているメディア<strong>%3$d</strong>のうち)<strong>%1$d</strong> から <strong>%2$d</strong>を表示',
    'TEXT_ADD_MEDIA_CLIP' => 'メディアクリップを追加',
    'TEXT_MEDIA_CLIP_DIR' => 'メディアディレクトリにアップロード',
    'TEXT_MEDIA_CLIP_TYPE' => 'メディアクリップのフォーマット',
    'TEXT_HEADING_ASSIGN_MEDIA_COLLECTION' => '商品にアルバムを割り当てる',
