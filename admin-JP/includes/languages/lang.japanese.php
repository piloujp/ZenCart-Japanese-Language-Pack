 ...
 * @version $Id: piloujp 2024 May 25 Modified in v2.0.1 $
*/
...
$define = [
    ...
    'TEXT_DISPLAY_NUMBER_OF_COUNTRIES' => '<b>%1$d</b> から <b>%2$d</b> を表示しています（全<b>%3$d</b>件）',
    ...
    'TEXT_DISPLAY_NUMBER_OF_ZONES' => '<b>%1$d</b> から <b>%2$d</b> を表示しています（全<b>%3$d</b>件）',
