...
$define = [
     ...
     'RECAPTCHA_BAD_REQUEST' => 'reCaptcha: リクエストが無効であるか、形式が正しくありません',
     'RECAPTCHA_TIMEOUT_OR_DUPLICATE' => 'reCaptcha: タイムアウトまたは重複リクエスト',
     'RECAPTCHA_PRIVATE_KEY_NOT_MATCHED' => 'reCaptcha: 秘密鍵がこのドメインと一致しません',
];
