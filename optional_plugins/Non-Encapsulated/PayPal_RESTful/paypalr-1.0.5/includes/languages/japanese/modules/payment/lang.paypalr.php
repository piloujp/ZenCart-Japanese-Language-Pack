...
$define = [
    ...
    //
    'MODULE_PAYMENT_PAYPALR_ALERT_SUBJECT' => '警告： PayPal チェックアウト エラー（%s）',    //- %s is an additional error descriptor, see below
...
// bof constant configuration titles and descriptions for payment module paypalr
    ...
    'CFGDESC_MODULE_PAYMENT_PAYPALDP_CURRENCY' => 'PayPal への注文はどの通貨で送信すればよいですか？<br>注意： サポートされていない通貨が PayPal に送信された場合、<em>代替通貨</em>に自動的に変換されます。<br><strong>デフォルト：選択された通貨</strong>',
...
if (IS_ADMIN_FLAG === true) {
    $define['MODULE_PAYMENT_PAYPALR_TEXT_ADMIN_DESCRIPTION'] =
        ...
        '<a href="https://www.paypal.com" rel="noopener noreferrer" target="_blank">PayPal <b>ビジネス</b> アカウントを管理する</a><br><br>' .
        '<b>設定手順：</b><br>' .
        '<ol>
