...
$define = [
    'MODULE_PAYMENT_PAYPALR_TEXT_TITLE' => 'PayPal支払い',
        'MODULE_PAYMENT_PAYPALR_SUBTITLE' => '（<b>PayPal ウォレット</b>または<b>クレジットカード</b>のいずれかをご利用ください）',
    'MODULE_PAYMENT_PAYPALR_TEXT_TITLE_ADMIN' => 'PayPal支払い（RESTful）',
    'MODULE_PAYMENT_PAYPALR_TEXT_DESCRIPTION' => '<strong>PayPal</strong>',
    'MODULE_PAYMENT_PAYPALR_TEXT_TYPE' => 'PayPal支払い',
    ...
    // Storefront messages.
    //
    'MODULE_PAYMENT_PALPALR_PAYING_WITH_PAYPAL' => 'PayPalウォレットで支払う',     //- Used by the confirmation method, when paying via PayPal Checkout (paypal)
    ...
    'MODULE_PAYMENT_PAYPALR_UNSUPPORTED_BILLING_COUNTRY' => '請求先住所の国は PayPal でサポートされていないため、クレジットカードでの支払いはできません。',
    'MODULE_PAYMENT_PAYPALR_UNSUPPORTED_SHIPPING_COUNTRY' => '配送先の国は PayPal でサポートされていないため、この支払い方法は使用できません。',
    ...
    'MODULE_PAYMENT_PAYPALR_TRANSACTION_TYPE' => '支払いタイプ： PayPal Checkout (%s)',  //- %s filled in with either 'paypal' or 'card'
    ...
    'MODULE_PAYMENT_PAYPALR_CARD_PROCESSING' => 'カードでお支払いいただくことで、PayPal.com で利用可能な %s に従って、お客様のデータが PayPal によって処理されることに同意することになります。',  //- %s is filled in with a link
    'MODULE_PAYMENT_PAYPALR_PAYPAL_PRIVACY_STMT' => 'PayPal プライバシー ポリシー',
    ...
    //
    'MODULE_PAYMENT_PAYPALR_ALERT_SUBJECT' => '警告： PayPal チェックアウト（%s）',    //- %s is an additional error descriptor, see below
    ...
    'MODULE_PAYMENT_PAYPALR_ALERT_ORDER_CREATION' => 'PayPal の応答ステータスが \'%2$s\' であるため、注文番号 %1$u のステータスは強制的に「処理待ち」になりました。',
    ...
    'MODULE_PAYMENT_PAYPALR_ALERT_ORDER_CREATE' => '注文を開始しようとしたときに PayPal からエラーが返されました。礼儀として、エラー \'code\' のみが顧客に表示されました。エラーの詳細は以下に表示されます。' . "\n\n",
    'MODULE_PAYMENT_PAYPALR_ALERT_TOTAL_MISMATCH' => '注文の総額と内訳に矛盾が見つかりました。注文は、商品と費用の内訳が含まれないまま PayPal に送信されています。',
    'MODULE_PAYMENT_PAYPALR_ALERT_CONFIRMATION_ERROR' => 'PayPal ウォレットから顧客の支払い選択を確認しようとしたときに、PayPal から処理できない返品を受け取りました。',
    'MODULE_PAYMENT_PAYPALR_ALERT_EXTERNAL_TXNS' => '注文番号 %u のステータスを確認してください。PayPal 取引は支払いモジュールの処理外で追加されました。',
    ...
    'MODULE_PAYMENT_PAYPALR_ALERT_UNKNOWN_DENIAL' =>
        'PayPal は、クレジットカード支払いが拒否されたため、不明な応答コード（%1$s）を返しました。' . "\n\n" .
    ...
    //
    'MODULE_PAYMENT_PAYPALR_BUTTON_ALTTEXT' => 'PayPalウォレットで支払うにはここをクリックしてください',
    ...
    'MODULE_PAYMENT_PAYPALR_CHOOSE_PAYPAL' => 'PayPalウォレット：',
    ...
    //
    'MODULE_PAYMENT_PAYPALR_TEXT_GETDETAILS_ERROR' => 'PayPal 取引の詳細を取得中に問題が発生しました。',
    'MODULE_PAYMENT_PAYPALR_NO_RECORDS' => '注文番号 %2$u のデータベースに \'%1$s\' レコードが見つかりませんでした。',
    'MODULE_PAYMENT_PAYPALR_EXTERNAL_ADDITION' => 'PayPal 取引が支払いモジュールの処理外で追加されました。注文のステータスが正しいことを確認してください。',

    // -----
    // Used during the admin's display of the payment transactions on an
    // order's detailed view.
    //
    'MODULE_PAYMENT_PAYPALR_NO_RECORDS_FOUND' => 'この注文の PayPal 取引はデータベースに記録されません。',

    'MODULE_PAYMENT_PAYPALR_TXN_TABLE_CAPTION' => 'PayPal取引',
    'MODULE_PAYMENT_PAYPALR_PAYMENTS_TABLE_CAPTION' => '決済された支払い',
    'MODULE_PAYMENT_PAYPALR_PAYMENTS_TABLE_NOTE' => '注意： 払い戻し手数料は PayPal によって返金されます。',
    ...
    //
    'MODULE_PAYMENT_PAYPALR_DETAILS_TITLE' => 'PayPal 取引の詳細（%s）',    //- %s is one of the following two strings
        'MODULE_PAYMENT_PAYPALR_DETAILS_TYPE_PAYPAL' => 'PayPalウォレット',
...
// bof constant configuration titles and descriptions for payment module paypalr
    ...
    'CFGDESC_MODULE_PAYMENT_PAYPALR_CLIENTID_L' => '<b>ライブ</b>サイトの*API アクセス*の PayPal API 署名設定からの <em>クライアント ID</em>。<b>ライブ</b>環境を使用する場合に必要です。',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SECRET_L' => 'クライアントシークレット（ライブ）',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SECRET_L' => '<b>ライブ</b>サイトの*API アクセス*の下にある PayPal API 署名設定からの <em>クライアント シークレット</em>。<b>ライブ</b>環境を使用する場合に必要です。',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_CLIENTID_S' => 'クライアント ID（サンドボックス）',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_CLIENTID_S' => '<b>サンドボックス</b> サイトの *API アクセス* の PayPal API 署名設定の <em>クライアント ID</em>。<b>サンドボックス</b> 環境を使用する場合に必要です。',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SECRET_S' => 'クライアントシークレット（サンドボックス）',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SECRET_S' => '<b>サンドボックス</b> サイトの *API アクセス* の PayPal API 署名設定からの <em>クライアント シークレット</em>。<b>サンドボックス</b> 環境を使用する場合に必要です。',
    ...
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_BRANDNAME' => 'PayPal のストア（ブランド）名',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_BRANDNAME' => 'PayPal ログイン ページに表示されるストアの名前。空白の場合は、ストア名が使用されます。',
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_TRANSACTION_MODE' => '支払いアクション',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_TRANSACTION_MODE' => '支払いはどのように受け取りたいですか？<br><strong>デフォルト：最終販売</strong><br>「認証のみ」を選択した場合は、支払いを確定するために PayPal による確認が必要になります。',
    ...
    'CFGTITLE_MODULE_PAYMENT_PAYPALR_SOFT_DESCRIPTOR' => 'PayPal のストア（サブブランド）識別子',
    'CFGDESC_MODULE_PAYMENT_PAYPALR_SOFT_DESCRIPTOR' => '顧客のクレジットカード明細書には、会社名が<code>PAYPAL*(yourname)*(your-sub-brand-name)</code>と表示されます（(yourname)*(your-sub-brand-name)は最大22文字）。このストアでの購入と他のPayPalでの購入を区別したい場合は、ここにサブブランド名を追加できます。',
...
if (IS_ADMIN_FLAG === true) {
    $define['MODULE_PAYMENT_PAYPALR_TEXT_ADMIN_DESCRIPTION'] =
        '<b>PayPal支払い（RESTful）</b>, v%s<br><br>' .   //- %s is filled in with the current module version
        '<a href="https://www.paypal.com/login" rel="noopener noreferrer" target="_blank">PayPal <b>ビジネス</b> アカウントを管理する</a><br><br>' .
        '<b>設定手順：</b><br>' .
        '<ol>
            <li><a href="https://github.com/lat9/paypalr/wiki/Creating-PayPal-Credentials" rel="noopener noreferrer" target="_blank">PayPal 認証情報を作成します（英語）。</a></li>
