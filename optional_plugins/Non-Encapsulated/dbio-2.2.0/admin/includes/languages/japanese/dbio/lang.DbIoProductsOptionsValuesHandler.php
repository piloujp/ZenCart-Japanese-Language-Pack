...
$define = [
    ...
    'DBIO_PRODUCTSOPTIONSVALUES_DESCRIPTION' => 'このレポート形式は、<code>products_options_values</code> テーブル内の<b>すべての</b>フィールドのインポート/エクスポートをサポートしています。このレポートを使用して、ストアの商品オプションの値に関する情報を追加または変更してください。DbIo CSV の一つのレコードは、一つの言語固有の商品オプション値に対応します。' .
    '<br><br>' .
    '<b>注記：</b>' .
    '<ol>' .
