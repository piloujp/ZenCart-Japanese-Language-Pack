...
$define = [
    'ADMIN_PLUGIN_MANAGER_NAME_FOR_VAT4EU' => 'EU 諸国のVAT',
    'ADMIN_PLUGIN_MANAGER_DESCRIPTION_FOR_VAT4EU' => 'このプラグインは、ストアを更新して、EU の「VAT 番号」を収集、表示、検証します。詳細については、<em>VAT4EU</em> の <a href="https://github.com/lat9/vat4eu/wiki" target="_blank" rel="noopener noreferrer">ウィキ</a> を参照してください。',
// Admin configuration group
    'CFG_GRP_TITLE_VAT4EU_PLUGIN' => 'EU 諸国向けのVAT プラグイン（VAT4EU）',
// Admin configuration
