...
$define = [
    ...
    'TEXT_PREVIOUS_EXPORTS' => '以前にエクスポートした注文を含める。デフォルトでは、エクスポート ファイルには、まだエクスポートされていない注文のみが含まれます。すでにダウンロードされている日付範囲の注文を含める場合は、以下のチェックボックスをオンにしてください。この機能を日付範囲機能と組み合わせると、さらに柔軟性が高まります。',
