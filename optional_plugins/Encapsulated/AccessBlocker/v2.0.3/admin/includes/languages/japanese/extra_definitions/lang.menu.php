...
// Admin configuration
    ...
    'CFGTITLE_ACCESSBLOCK_BLOCKED_COMPANIES' => 'ブロック元：会社',
    'CFGDESC_ACCESSBLOCK_BLOCKED_COMPANIES' => 'カンマ区切りで、アカウント作成をブロックしたい会社名を入力してください。「アカウント作成」ページに入力された会社名に、ここに入力された文字列のいずれかが含まれている場合、アカウント作成はブロックされます。',
