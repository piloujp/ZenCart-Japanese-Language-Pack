...
// Success, Warning, and Error Messages
    ...
    'ERROR_DISPLAY_PRICE_WITH_TAX' => 'Zen Cart が' . (zen_config('DISPLAY_PRICE_WITH_TAX_ADMIN') !== 'true' ? '税込' : '税抜') . '価格を表示するように設定されました。 このページは現在' . (DISPLAY_PRICE_WITH_TAX !== 'true' ? '税込み' : '税抜き') . 'の価格を表示しています。両方の設定が同じになるまで注文を編集することはできません。',
...
// ot_coupon messages, present in the storefront main language file
    ...
    'TEXT_INVALID_REDEEM_COUPON' => '無効なクーポンコード（%1$s）です',
