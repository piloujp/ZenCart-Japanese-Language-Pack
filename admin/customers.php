        ...
        case 'update':
            ...
            if (ACCOUNT_STATE === 'true') {
                ...
                if ($entry_state_has_zones) {
					if ($_SESSION['language'] == "japanese" && (int)$entry_country_id === 107) {
                    $zone_query = $db->Execute(
                        "SELECT zone_id
                           FROM " . TABLE_ZONES . "
                           WHERE zone_country_id = " . (int)$entry_country_id . "
                             AND zone_code = '" . zen_db_input($entry_state) . "'"
                    );
					} else {
                    $zone_query = $db->Execute(
                        "SELECT zone_id
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
                    <table class="table table-hover" role="listbox">
                        ...
                        <tr class="dataTableHeadingRow">
                            ...
                            <th class="dataTableHeadingContent">
                                <?php echo (($_GET['list_order'] === 'lastname_kana' || $_GET['list_order'] === 'lastname_kana-desc') ?
                                ...
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(['list_order', 'page']) . 'list_order=lastname_kana',
                                    'NONSSL'
                                ); ?>">
                                    <?php echo ($_GET['list_order'] === 'lastname_kana') ?
                                        '<span class="SortOrderHeader">' . TEXT_ASC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_ASC . '</span>'; ?>
                                </a>&nbsp;
                                <a href="<?php
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(['list_order', 'page']) . 'list_order=lastname_kana-desc',
                                    'NONSSL'
                                ); ?>">
                                    <?php echo ($_GET['list_order'] === 'lastname_kana-desc') ?
                                        '<span class="SortOrderHeader">' . TEXT_DESC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_DESC . '</span>'; ?>
                                </a>
                            </th>
                            ...
                            <th class="dataTableHeadingContent">
                                <?php echo ($_GET['list_order'] === 'firstname_kana' || $_GET['list_order'] === 'firstname_kana-desc') ?
                                ...
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(['list_order', 'page']) . 'list_order=firstname_kana',
                                    'NONSSL'
                                ); ?>">
                                    <?php echo ($_GET['list_order'] === 'firstname_kana') ?
                                        '<span class="SortOrderHeader">' . TEXT_ASC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_ASC . '</span>'; ?>
                                </a>&nbsp;
                                <a href="<?php
                                echo zen_href_link(
                                    basename($PHP_SELF),
                                    zen_get_all_get_params(['list_order', 'page']) . 'list_order=firstname_kana-desc',
                                    'NONSSL'
                                ); ?>">
                                    <?php echo ($_GET['list_order'] === 'firstname_kana-desc') ?
                                        '<span class="SortOrderHeader">' . TEXT_DESC . '</span>' :
                                        '<span class="SortOrderHeaderLink">' . TEXT_DESC . '</span>'; ?>
                                </a>
                            </th>
...
?>
                                ...
                                <td class="dataTableContent"><?php echo $customer['customers_lastname_kana']; ?></td>
                                <td class="dataTableContent"><?php echo $customer['customers_firstname']; ?></td>
                                <td class="dataTableContent"><?php echo $customer['customers_firstname_kana']; ?></td>
<?php
        if (ACCOUNT_COMPANY === 'true') {
?>
