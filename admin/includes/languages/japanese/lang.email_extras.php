...
$define = [
    ...
    'TEXT_EMAIL_MESSAGE_ADMIN_MFA_DELETED' => 'Administrative alert: MFA settings for an admin user (%s) have been DISABLED by %s.' . "\n\n" . 'If you or an authorized administrator did not initiate this change, it is advised that you verify your site security immediately.',
    'TEXT_EMAIL_SUBJECT_ADMIN_MFA_EXEMPTED' => 'Admin Alert: MFA for an admin user has been marked as EXEMPT.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MFA_EXEMPTED' => 'Administrative alert: MFA settings for an admin user (%s) have been EXEMPTED by %s.' . "\n\n" . 'If you or an authorized administrator did not initiate this change, it is advised that you verify your site security immediately.',
    'TEXT_EMAIL_SUBJECT_ADMIN_MFA_UNEXEMPTED' => 'Admin Alert: MFA for an admin user has been marked as NO LONGER EXEMPT.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MFA_UNEXEMPTED' => 'Administrative alert: MFA settings for an admin user (%s) have been marked as NO LONGER EXEMPT by %s.' . "\n\n" . 'If you or an authorized administrator did not initiate this change, it is advised that you verify your site security immediately.',
